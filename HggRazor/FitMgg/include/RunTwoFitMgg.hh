...
RooWorkspace* MakeDataCard( TTree* treeData, TTree* treeSignal, TTree* treeSMH, TString mggName, float SMH_Yield = 1e-2, float SMH_YieldUn = 1e-2,
			    float Signal_Yield = 1.0, TString binNumber = "-1" );
