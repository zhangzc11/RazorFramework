...
inputList = "/afs/cern.ch/work/z/zhicaiz/public/BiasSignalTest_Leptons_35p9ifb_05June2017_cmscaf1nd_hacked/trees/"
	...
	with open(bin_list_filename,"r") as bin_list_file:
		for this_bin in bin_list_file:
			...
			for SoverB_index in range(len(SoverB)):
				...
				env_script_yes.write("./PlotAllBiasTest --fitFunc=doublecrystalBall --inputFile="+inputList+bin_array[0]+"_"+bin_array[1]+"_"+bin_array[3]+"/SoB_"+SoverB[SoverB_index]+"/Tree/list.list --mode=table2 --requireFitStatus=yes --category="+bin_array[0]+" --SoB="+SoverB[SoverB_index]+" --LowMRcut="+bin_array[1]+" --HighMRcut="+bin_array[2]+" --LowRSQcut="+bin_array[3]+" --HighRSQcut="+bin_array[4]+" ")	
