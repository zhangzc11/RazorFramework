void mgg_Hbb_Mr200Rsq0p02_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:14:52 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(94.75904,-0.005862193,163.4337,0.04298941);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   vH_Hbb_mgg__27->SetBinContent(15,0.0007735559);
   ...
   vH_Hbb_mgg__27->SetBinError(15,0.0004466127);
   ...
   ttH_Hbb_mgg__28->SetBinContent(8,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(9,0.0003420033);
   ttH_Hbb_mgg__28->SetBinContent(10,0.0002850028);
   ttH_Hbb_mgg__28->SetBinContent(11,0.0004560044);
   ttH_Hbb_mgg__28->SetBinContent(12,0.0009120089);
   ttH_Hbb_mgg__28->SetBinContent(13,0.001596016);
   ttH_Hbb_mgg__28->SetBinContent(14,0.01003211);
   ttH_Hbb_mgg__28->SetBinContent(15,0.01806921);
   ttH_Hbb_mgg__28->SetBinContent(16,0.005301058);
   ttH_Hbb_mgg__28->SetBinContent(17,0.000513005);
   ttH_Hbb_mgg__28->SetBinContent(18,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(19,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(20,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(21,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(25,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(38,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(39,0.0004560044);
   ...
   ttH_Hbb_mgg__28->SetBinError(8,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(9,0.0001396223);
   ttH_Hbb_mgg__28->SetBinError(10,0.0001274571);
   ttH_Hbb_mgg__28->SetBinError(11,0.0001612219);
   ttH_Hbb_mgg__28->SetBinError(12,0.0002280022);
   ttH_Hbb_mgg__28->SetBinError(13,0.0003016186);
   ttH_Hbb_mgg__28->SetBinError(14,0.0007561979);
   ttH_Hbb_mgg__28->SetBinError(15,0.001014866);
   ttH_Hbb_mgg__28->SetBinError(16,0.0005496935);
   ttH_Hbb_mgg__28->SetBinError(17,0.0001710017);
   ttH_Hbb_mgg__28->SetBinError(18,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(19,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(20,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(21,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(25,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(38,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(39,0.0001612219);
   ttH_Hbb_mgg__28->SetEntries(686);
