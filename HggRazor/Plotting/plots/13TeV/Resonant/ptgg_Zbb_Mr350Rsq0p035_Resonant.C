void ptgg_Zbb_Mr350Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:16:09 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-5.167212,762.1687,-1.463508);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.02181875);
   
   TH1F *hs_stack_12 = new TH1F("hs_stack_12","",70,20,720);
   hs_stack_12->SetMinimum(0.1493842);
   hs_stack_12->SetMaximum(0.01893357);
   ...
   vbfH_Zbb_ptgg__46->SetEntries(1);
   ...
   vH_Zbb_ptgg__47->SetBinContent(6,0.000257852);
   vH_Zbb_ptgg__47->SetBinContent(9,0.000257852);
   vH_Zbb_ptgg__47->SetBinError(6,0.000257852);
   vH_Zbb_ptgg__47->SetBinError(9,0.000257852);
   vH_Zbb_ptgg__47->SetEntries(2);
   ...
   ttH_Zbb_ptgg__48->SetBinContent(1,0.0002850028);
   ttH_Zbb_ptgg__48->SetBinContent(2,0.0004560044);
   ttH_Zbb_ptgg__48->SetBinContent(3,0.0004560044);
   ttH_Zbb_ptgg__48->SetBinContent(4,0.001197012);
   ttH_Zbb_ptgg__48->SetBinContent(5,0.0009690094);
   ttH_Zbb_ptgg__48->SetBinContent(6,0.001482014);
   ttH_Zbb_ptgg__48->SetBinContent(7,0.001482014);
   ttH_Zbb_ptgg__48->SetBinContent(8,0.001311013);
   ttH_Zbb_ptgg__48->SetBinContent(9,0.001425014);
   ttH_Zbb_ptgg__48->SetBinError(1,0.0001274571);
   ttH_Zbb_ptgg__48->SetBinError(2,0.0001612219);
   ttH_Zbb_ptgg__48->SetBinError(3,0.0001612219);
   ttH_Zbb_ptgg__48->SetBinError(4,0.0002612094);
   ttH_Zbb_ptgg__48->SetBinError(5,0.0002350193);
   ttH_Zbb_ptgg__48->SetBinError(6,0.000290647);
   ttH_Zbb_ptgg__48->SetBinError(7,0.000290647);
   ttH_Zbb_ptgg__48->SetBinError(8,0.0002733651);
   ttH_Zbb_ptgg__48->SetBinError(9,0.0002850028);
   ttH_Zbb_ptgg__48->SetEntries(159);
