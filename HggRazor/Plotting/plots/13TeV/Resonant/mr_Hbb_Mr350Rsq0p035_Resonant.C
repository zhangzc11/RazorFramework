void mr_Hbb_Mr350Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:16:09 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-4.937297,2147.47,-1.233593);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.03534037);
   
   TH1F *hs_stack_5 = new TH1F("hs_stack_5","",160,130,8130);
   hs_stack_5->SetMinimum(0.1291763);
   hs_stack_5->SetMaximum(0.03214752);
   ...
   ttH_Hbb_mr__20->SetBinContent(5,0.002223022);
   ttH_Hbb_mr__20->SetBinContent(6,0.003534037);
   ttH_Hbb_mr__20->SetBinContent(7,0.002964031);
   ttH_Hbb_mr__20->SetBinContent(8,0.002223022);
   ttH_Hbb_mr__20->SetBinContent(9,0.001311013);
   ttH_Hbb_mr__20->SetBinContent(10,0.0008550083);
   ttH_Hbb_mr__20->SetBinContent(11,0.0007980078);
   ttH_Hbb_mr__20->SetBinContent(12,0.0007980078);
   ttH_Hbb_mr__20->SetBinContent(13,0.0001710017);
   ttH_Hbb_mr__20->SetBinContent(14,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(15,0.0002280022);
   ttH_Hbb_mr__20->SetBinContent(16,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(17,5.700056e-05);
   ...
   ttH_Hbb_mr__20->SetBinError(5,0.0003559684);
   ttH_Hbb_mr__20->SetBinError(6,0.0004488228);
   ttH_Hbb_mr__20->SetBinError(7,0.0004110369);
   ttH_Hbb_mr__20->SetBinError(8,0.0003559684);
   ttH_Hbb_mr__20->SetBinError(9,0.0002733651);
   ttH_Hbb_mr__20->SetBinError(10,0.0002207622);
   ttH_Hbb_mr__20->SetBinError(11,0.0002132766);
   ttH_Hbb_mr__20->SetBinError(12,0.0002132766);
   ttH_Hbb_mr__20->SetBinError(13,9.872786e-05);
   ttH_Hbb_mr__20->SetBinError(14,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(15,0.0001140011);
   ttH_Hbb_mr__20->SetBinError(16,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(17,5.700056e-05);
