void ptgg_LowRes_Mr250Rsq0p02_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:15:18 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-1.490499,762.1687,0.6674468);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(2.562109);
   
   TH1F *hs_stack_20 = new TH1F("hs_stack_20","",70,20,720);
   hs_stack_20->SetMinimum(0.05867516);
   hs_stack_20->SetMaximum(3.283905);
   ...
   ggH_LowRes_ptgg__77->SetBinContent(1,0.01514238);
   ggH_LowRes_ptgg__77->SetBinContent(2,0.05047462);
   ggH_LowRes_ptgg__77->SetBinContent(3,0.03028477);
   ggH_LowRes_ptgg__77->SetBinContent(4,0.1059967);
   ggH_LowRes_ptgg__77->SetBinContent(5,0.09590178);
   ggH_LowRes_ptgg__77->SetBinContent(6,0.1160916);
   ggH_LowRes_ptgg__77->SetBinContent(7,0.1362815);
   ggH_LowRes_ptgg__77->SetBinContent(8,0.1110442);
   ggH_LowRes_ptgg__77->SetBinContent(9,0.1817086);
   ggH_LowRes_ptgg__77->SetBinError(1,0.00874246);
   ggH_LowRes_ptgg__77->SetBinError(2,0.01596147);
   ggH_LowRes_ptgg__77->SetBinError(3,0.01236371);
   ggH_LowRes_ptgg__77->SetBinError(4,0.02313037);
   ggH_LowRes_ptgg__77->SetBinError(5,0.02200137);
   ggH_LowRes_ptgg__77->SetBinError(6,0.02420677);
   ggH_LowRes_ptgg__77->SetBinError(7,0.02622738);
   ggH_LowRes_ptgg__77->SetBinError(8,0.02367469);
   ggH_LowRes_ptgg__77->SetBinError(9,0.03028477);
   ggH_LowRes_ptgg__77->SetEntries(167);
   ...
   vbfH_LowRes_ptgg__78->SetBinContent(1,0.007956154);
   vbfH_LowRes_ptgg__78->SetBinContent(2,0.01105021);
   vbfH_LowRes_ptgg__78->SetBinContent(3,0.01237624);
   vbfH_LowRes_ptgg__78->SetBinContent(4,0.02254245);
   vbfH_LowRes_ptgg__78->SetBinContent(5,0.03226665);
   vbfH_LowRes_ptgg__78->SetBinContent(6,0.0296146);
   vbfH_LowRes_ptgg__78->SetBinContent(7,0.03757077);
   vbfH_LowRes_ptgg__78->SetBinContent(8,0.04464292);
   vbfH_LowRes_ptgg__78->SetBinContent(9,0.05348311);
   vbfH_LowRes_ptgg__78->SetBinError(1,0.001875284);
   vbfH_LowRes_ptgg__78->SetBinError(2,0.002210043);
   vbfH_LowRes_ptgg__78->SetBinError(3,0.00233889);
   vbfH_LowRes_ptgg__78->SetBinError(4,0.003156573);
   vbfH_LowRes_ptgg__78->SetBinError(5,0.003776523);
   vbfH_LowRes_ptgg__78->SetBinError(6,0.003617996);
   vbfH_LowRes_ptgg__78->SetBinError(7,0.004075118);
   vbfH_LowRes_ptgg__78->SetBinError(8,0.004442131);
   vbfH_LowRes_ptgg__78->SetBinError(9,0.004862094);
   vbfH_LowRes_ptgg__78->SetEntries(569);
   ...
   vH_LowRes_ptgg__79->SetBinContent(1,0.002836372);
   vH_LowRes_ptgg__79->SetBinContent(2,0.003352076);
   vH_LowRes_ptgg__79->SetBinContent(3,0.004383484);
   vH_LowRes_ptgg__79->SetBinContent(4,0.00515704);
   vH_LowRes_ptgg__79->SetBinContent(5,0.005930596);
   vH_LowRes_ptgg__79->SetBinContent(6,0.0064463);
   vH_LowRes_ptgg__79->SetBinContent(7,0.009798373);
   vH_LowRes_ptgg__79->SetBinContent(8,0.01211904);
   vH_LowRes_ptgg__79->SetBinContent(9,0.01366615);
   vH_LowRes_ptgg__79->SetBinError(1,0.0008551982);
   vH_LowRes_ptgg__79->SetBinError(2,0.0009296985);
   vH_LowRes_ptgg__79->SetBinError(3,0.001063151);
   vH_LowRes_ptgg__79->SetBinError(4,0.001153149);
   vH_LowRes_ptgg__79->SetBinError(5,0.001236615);
   vH_LowRes_ptgg__79->SetBinError(6,0.00128926);
   vH_LowRes_ptgg__79->SetBinError(7,0.001589506);
   vH_LowRes_ptgg__79->SetBinError(8,0.001767744);
   vH_LowRes_ptgg__79->SetBinError(9,0.001877191);
   vH_LowRes_ptgg__79->SetEntries(247);
   ...
   ttH_LowRes_ptgg__80->SetBinContent(1,0.003648039);
   ttH_LowRes_ptgg__80->SetBinContent(2,0.00467405);
   ttH_LowRes_ptgg__80->SetBinContent(3,0.005187056);
   ttH_LowRes_ptgg__80->SetBinContent(4,0.006669074);
   ttH_LowRes_ptgg__80->SetBinContent(5,0.009405105);
   ttH_LowRes_ptgg__80->SetBinContent(6,0.007125079);
   ttH_LowRes_ptgg__80->SetBinContent(7,0.007467083);
   ttH_LowRes_ptgg__80->SetBinContent(8,0.006783075);
   ttH_LowRes_ptgg__80->SetBinContent(9,0.007353082);
   ttH_LowRes_ptgg__80->SetBinError(1,0.0004560045);
   ttH_LowRes_ptgg__80->SetBinError(2,0.000516162);
   ttH_LowRes_ptgg__80->SetBinError(3,0.0005437507);
   ttH_LowRes_ptgg__80->SetBinError(4,0.0006165553);
   ttH_LowRes_ptgg__80->SetBinError(5,0.0007321854);
   ttH_LowRes_ptgg__80->SetBinError(6,0.0006372856);
   ttH_LowRes_ptgg__80->SetBinError(7,0.0006524012);
   ttH_LowRes_ptgg__80->SetBinError(8,0.0006218027);
   ttH_LowRes_ptgg__80->SetBinError(9,0.0006474019);
   ttH_LowRes_ptgg__80->SetEntries(1023);
