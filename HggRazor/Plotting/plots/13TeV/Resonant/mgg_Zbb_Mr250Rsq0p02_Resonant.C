void mgg_Zbb_Mr250Rsq0p02_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:15:18 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(94.75904,-0.005366976,163.4337,0.03935783);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   vH_Zbb_mgg__43->SetBinContent(15,0.001031408);
   vH_Zbb_mgg__43->SetBinContent(16,0.0005157039);
   vH_Zbb_mgg__43->SetBinContent(17,0.000257852);
   vH_Zbb_mgg__43->SetBinError(14,0.000257852);
   vH_Zbb_mgg__43->SetBinError(15,0.0005157039);
   vH_Zbb_mgg__43->SetBinError(16,0.0003646577);
   vH_Zbb_mgg__43->SetBinError(17,0.000257852);
   vH_Zbb_mgg__43->SetEntries(8);
   ...
   ttH_Zbb_mgg__44->SetBinContent(1,5.700056e-05);
   ...
   ttH_Zbb_mgg__44->SetBinContent(11,0.0001710017);
   ttH_Zbb_mgg__44->SetBinContent(12,0.000513005);
   ttH_Zbb_mgg__44->SetBinContent(13,0.001710017);
   ttH_Zbb_mgg__44->SetBinContent(14,0.005358058);
   ttH_Zbb_mgg__44->SetBinContent(15,0.01117213);
   ttH_Zbb_mgg__44->SetBinContent(16,0.003249034);
   ...
   ttH_Zbb_mgg__44->SetBinError(1,5.700056e-05);
   ...
   ttH_Zbb_mgg__44->SetBinError(11,9.872786e-05);
   ttH_Zbb_mgg__44->SetBinError(12,0.0001710017);
   ttH_Zbb_mgg__44->SetBinError(13,0.0003122049);
   ttH_Zbb_mgg__44->SetBinError(14,0.0005526409);
   ttH_Zbb_mgg__44->SetBinError(15,0.0007980078);
   ttH_Zbb_mgg__44->SetBinError(16,0.0004303448);
   ...
   ttH_Zbb_mgg__44->SetEntries(413);
