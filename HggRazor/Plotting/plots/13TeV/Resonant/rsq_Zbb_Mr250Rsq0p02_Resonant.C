void rsq_Zbb_Mr250Rsq0p02_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:15:18 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.052125,1.060241,-0.8448565);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.1347495);
   
   TH1F *hs_stack_10 = new TH1F("hs_stack_10","",125,0,5);
   hs_stack_10->SetMinimum(0.09391756);
   hs_stack_10->SetMaximum(0.1382403);
   ...
   vH_Zbb_rsq__39->SetBinContent(1,0.001031408);
   vH_Zbb_rsq__39->SetBinContent(2,0.001031408);
   vH_Zbb_rsq__39->SetBinError(1,0.0005157039);
   vH_Zbb_rsq__39->SetBinError(2,0.0005157039);
   vH_Zbb_rsq__39->SetEntries(8);
   ...
   ttH_Zbb_rsq__40->SetBinContent(1,0.006954077);
   ttH_Zbb_rsq__40->SetBinContent(2,0.008436094);
   ttH_Zbb_rsq__40->SetBinContent(3,0.003591038);
   ttH_Zbb_rsq__40->SetBinContent(4,0.001881018);
   ttH_Zbb_rsq__40->SetBinContent(5,0.001254012);
   ttH_Zbb_rsq__40->SetBinContent(6,0.0006840067);
   ttH_Zbb_rsq__40->SetBinContent(7,0.0003420033);
   ttH_Zbb_rsq__40->SetBinContent(8,0.0001140011);
   ...
   ttH_Zbb_rsq__40->SetBinError(1,0.0006295917);
   ttH_Zbb_rsq__40->SetBinError(2,0.0006934417);
   ttH_Zbb_rsq__40->SetBinError(3,0.0004524279);
   ttH_Zbb_rsq__40->SetBinError(4,0.0003274433);
   ttH_Zbb_rsq__40->SetBinError(5,0.0002673563);
   ttH_Zbb_rsq__40->SetBinError(6,0.0001974557);
   ttH_Zbb_rsq__40->SetBinError(7,0.0001396223);
   ttH_Zbb_rsq__40->SetBinError(8,8.061096e-05);
   ...
   ttH_Zbb_rsq__40->SetEntries(413);
