void rsq_Zbb_Mr350Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:16:09 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-4.68358,1.060241,-0.9798764);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.06030768);
   
   TH1F *hs_stack_10 = new TH1F("hs_stack_10","",125,0,5);
   hs_stack_10->SetMinimum(0.112336);
   hs_stack_10->SetMaximum(0.05765863);
   ...
   vH_Zbb_rsq__39->SetBinContent(2,0.0005157039);
   vH_Zbb_rsq__39->SetBinError(2,0.0003646577);
   vH_Zbb_rsq__39->SetEntries(2);
   ...
   ttH_Zbb_rsq__40->SetBinContent(1,0.0008550083);
   ttH_Zbb_rsq__40->SetBinContent(2,0.005073055);
   ttH_Zbb_rsq__40->SetBinContent(3,0.001653016);
   ttH_Zbb_rsq__40->SetBinContent(4,0.0006270061);
   ttH_Zbb_rsq__40->SetBinContent(5,0.0004560044);
   ttH_Zbb_rsq__40->SetBinContent(6,0.0002850028);
   ttH_Zbb_rsq__40->SetBinContent(8,5.700056e-05);
   ttH_Zbb_rsq__40->SetBinContent(12,5.700056e-05);
   ttH_Zbb_rsq__40->SetBinError(1,0.0002207622);
   ttH_Zbb_rsq__40->SetBinError(2,0.0005377422);
   ttH_Zbb_rsq__40->SetBinError(3,0.0003069574);
   ttH_Zbb_rsq__40->SetBinError(4,0.0001890495);
   ttH_Zbb_rsq__40->SetBinError(5,0.0001612219);
   ttH_Zbb_rsq__40->SetBinError(6,0.0001274571);
   ttH_Zbb_rsq__40->SetBinError(8,5.700056e-05);
   ttH_Zbb_rsq__40->SetBinError(12,5.700056e-05);
   ttH_Zbb_rsq__40->SetEntries(159);
