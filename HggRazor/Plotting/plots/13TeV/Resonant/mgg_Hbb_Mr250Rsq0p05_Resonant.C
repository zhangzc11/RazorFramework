void mgg_Hbb_Mr250Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:17:23 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(94.75904,-0.00274025,163.4337,0.02009517);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   vH_Hbb_mgg__27->SetBinContent(14,0.000257852);
   vH_Hbb_mgg__27->SetBinContent(15,0.000257852);
   vH_Hbb_mgg__27->SetBinError(14,0.000257852);
   vH_Hbb_mgg__27->SetBinError(15,0.000257852);
   vH_Hbb_mgg__27->SetEntries(2);
   ...
   ttH_Hbb_mgg__28->SetBinContent(13,0.00102601);
   ttH_Hbb_mgg__28->SetBinContent(14,0.005301058);
   ttH_Hbb_mgg__28->SetBinContent(15,0.008550095);
   ttH_Hbb_mgg__28->SetBinContent(16,0.002622027);
   ttH_Hbb_mgg__28->SetBinContent(17,0.0002280022);
   ...
   ttH_Hbb_mgg__28->SetBinContent(39,0.0003420033);
   ...
   ttH_Hbb_mgg__28->SetBinError(13,0.0002418329);
   ttH_Hbb_mgg__28->SetBinError(14,0.0005496935);
   ttH_Hbb_mgg__28->SetBinError(15,0.0006981114);
   ttH_Hbb_mgg__28->SetBinError(16,0.0003865966);
   ttH_Hbb_mgg__28->SetBinError(17,0.0001140011);
   ...
   ttH_Hbb_mgg__28->SetBinError(39,0.0001396223);
   ttH_Hbb_mgg__28->SetEntries(345);
