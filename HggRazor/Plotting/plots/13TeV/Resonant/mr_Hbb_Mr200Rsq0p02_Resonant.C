void mr_Hbb_Mr200Rsq0p02_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:14:52 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-1.04276,2147.47,-0.8731371);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.127611);
   
   TH1F *hs_stack_5 = new TH1F("hs_stack_5","",160,130,8130);
   hs_stack_5->SetMinimum(0.09497181);
   hs_stack_5->SetMaximum(0.1303135);
   ...
   ttH_Hbb_mr__20->SetBinContent(2,0.001425014);
   ttH_Hbb_mr__20->SetBinContent(3,0.006498072);
   ttH_Hbb_mr__20->SetBinContent(4,0.006783075);
   ttH_Hbb_mr__20->SetBinContent(5,0.005415059);
   ttH_Hbb_mr__20->SetBinContent(6,0.004902053);
   ttH_Hbb_mr__20->SetBinContent(7,0.003534037);
   ttH_Hbb_mr__20->SetBinContent(8,0.002964031);
   ttH_Hbb_mr__20->SetBinContent(9,0.001710017);
   ttH_Hbb_mr__20->SetBinContent(10,0.001368013);
   ttH_Hbb_mr__20->SetBinContent(11,0.001254012);
   ttH_Hbb_mr__20->SetBinContent(12,0.00102601);
   ttH_Hbb_mr__20->SetBinContent(13,0.0004560044);
   ttH_Hbb_mr__20->SetBinContent(14,0.0004560044);
   ttH_Hbb_mr__20->SetBinContent(15,0.0004560044);
   ttH_Hbb_mr__20->SetBinContent(16,0.0003990039);
   ttH_Hbb_mr__20->SetBinContent(17,0.0001140011);
   ttH_Hbb_mr__20->SetBinContent(18,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(21,0.0001140011);
   ttH_Hbb_mr__20->SetBinContent(22,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(23,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(26,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(2,0.0002850028);
   ttH_Hbb_mr__20->SetBinError(3,0.0006085994);
   ttH_Hbb_mr__20->SetBinError(4,0.0006218027);
   ttH_Hbb_mr__20->SetBinError(5,0.0005555727);
   ttH_Hbb_mr__20->SetBinError(6,0.0005286014);
   ttH_Hbb_mr__20->SetBinError(7,0.0004488228);
   ttH_Hbb_mr__20->SetBinError(8,0.0004110369);
   ttH_Hbb_mr__20->SetBinError(9,0.0003122049);
   ttH_Hbb_mr__20->SetBinError(10,0.0002792446);
   ttH_Hbb_mr__20->SetBinError(11,0.0002673563);
   ttH_Hbb_mr__20->SetBinError(12,0.0002418329);
   ttH_Hbb_mr__20->SetBinError(13,0.0001612219);
   ttH_Hbb_mr__20->SetBinError(14,0.0001612219);
   ttH_Hbb_mr__20->SetBinError(15,0.0001612219);
   ttH_Hbb_mr__20->SetBinError(16,0.0001508093);
   ttH_Hbb_mr__20->SetBinError(17,8.061096e-05);
   ttH_Hbb_mr__20->SetBinError(18,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(21,8.061096e-05);
   ttH_Hbb_mr__20->SetBinError(22,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(23,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(26,5.700056e-05);
   ttH_Hbb_mr__20->SetEntries(686);
