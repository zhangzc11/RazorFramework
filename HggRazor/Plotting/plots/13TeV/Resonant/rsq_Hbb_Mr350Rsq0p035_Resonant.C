void rsq_Hbb_Mr350Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:16:09 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-4.578857,1.060241,-0.875153);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.07524084);
   
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",125,0,5);
   hs_stack_6->SetMinimum(0.106584);
   hs_stack_6->SetMaximum(0.07338169);
   ...
   ttH_Hbb_rsq__24->SetBinContent(1,0.001539015);
   ttH_Hbb_rsq__24->SetBinContent(2,0.007524084);
   ttH_Hbb_rsq__24->SetBinContent(3,0.002850029);
   ttH_Hbb_rsq__24->SetBinContent(4,0.001596016);
   ttH_Hbb_rsq__24->SetBinContent(5,0.0009690094);
   ttH_Hbb_rsq__24->SetBinContent(6,0.0001710017);
   ttH_Hbb_rsq__24->SetBinContent(7,0.0002850028);
   ttH_Hbb_rsq__24->SetBinContent(8,0.0002850028);
   ttH_Hbb_rsq__24->SetBinContent(10,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(12,0.0001140011);
   ttH_Hbb_rsq__24->SetBinContent(20,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(1,0.0002961836);
   ttH_Hbb_rsq__24->SetBinError(2,0.0006548865);
   ttH_Hbb_rsq__24->SetBinError(3,0.0004030548);
   ttH_Hbb_rsq__24->SetBinError(4,0.0003016186);
   ttH_Hbb_rsq__24->SetBinError(5,0.0002350193);
   ttH_Hbb_rsq__24->SetBinError(6,9.872786e-05);
   ttH_Hbb_rsq__24->SetBinError(7,0.0001274571);
   ttH_Hbb_rsq__24->SetBinError(8,0.0001274571);
   ttH_Hbb_rsq__24->SetBinError(10,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(12,8.061096e-05);
   ttH_Hbb_rsq__24->SetBinError(20,5.700056e-05);
   ttH_Hbb_rsq__24->SetEntries(271);
