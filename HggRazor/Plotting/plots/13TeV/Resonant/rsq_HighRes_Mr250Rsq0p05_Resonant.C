void rsq_HighRes_Mr250Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:17:23 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.473532,1.060241,0.6024318);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(2.254752);
   
   TH1F *hs_stack_14 = new TH1F("hs_stack_14","",125,0,5);
   hs_stack_14->SetMinimum(0.05964632);
   hs_stack_14->SetMaximum(2.864932);
   ...
   vbfH_HighRes_rsq__54->SetBinContent(2,0.05348311);
   ...
   vbfH_HighRes_rsq__54->SetBinError(2,0.004862094);
   ...
   vbfH_HighRes_rsq__54->SetEntries(164);
   ...
   vH_HighRes_rsq__55->SetBinContent(2,0.01572896);
   ...
   vH_HighRes_rsq__55->SetBinError(2,0.002013888);
   ...
   vH_HighRes_rsq__55->SetEntries(125);
   ...
   ttH_HighRes_rsq__56->SetBinContent(2,0.01493417);
   ...
   ttH_HighRes_rsq__56->SetBinError(2,0.0009226346);
   ...
   ttH_HighRes_rsq__56->SetEntries(706);
