...
//=========  (Sun Jun  7 09:12:35 2015) by ROOT version6.03/05
   ...
   c->Range(-81.20482,-1.058485,762.1687,-0.8255521);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.1398526);
   
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",70,20,720);
   hs_stack_8->SetMinimum(0.09321095);
   hs_stack_8->SetMaximum(0.1439271);
   ...
   vbfH_Hbb_ptgg__30->SetBinContent(8,0.0004420086);
   ...
   vbfH_Hbb_ptgg__30->SetBinError(8,0.0004420086);
   vbfH_Hbb_ptgg__30->SetBinError(9,0.0004420086);
   vbfH_Hbb_ptgg__30->SetEntries(5);
   ...
   vH_Hbb_ptgg__31->SetBinContent(1,0.0005157039);
   vH_Hbb_ptgg__31->SetBinContent(2,0.000257852);
   vH_Hbb_ptgg__31->SetBinContent(4,0.0007735559);
   vH_Hbb_ptgg__31->SetBinContent(5,0.0005157039);
   vH_Hbb_ptgg__31->SetBinContent(6,0.0007735559);
   vH_Hbb_ptgg__31->SetBinContent(7,0.000257852);
   vH_Hbb_ptgg__31->SetBinContent(8,0.000257852);
   vH_Hbb_ptgg__31->SetBinContent(9,0.0007735559);
   vH_Hbb_ptgg__31->SetBinError(1,0.0003646577);
   vH_Hbb_ptgg__31->SetBinError(2,0.000257852);
   vH_Hbb_ptgg__31->SetBinError(4,0.0004466127);
   vH_Hbb_ptgg__31->SetBinError(5,0.0003646577);
   vH_Hbb_ptgg__31->SetBinError(6,0.0004466127);
   vH_Hbb_ptgg__31->SetBinError(7,0.000257852);
   vH_Hbb_ptgg__31->SetBinError(8,0.000257852);
   vH_Hbb_ptgg__31->SetBinError(9,0.0004466127);
   vH_Hbb_ptgg__31->SetEntries(16);
   ...
   ttH_Hbb_ptgg__32->SetBinContent(1,0.004446048);
   ttH_Hbb_ptgg__32->SetBinContent(2,0.005358058);
   ttH_Hbb_ptgg__32->SetBinContent(3,0.005871064);
   ttH_Hbb_ptgg__32->SetBinContent(4,0.005586061);
   ttH_Hbb_ptgg__32->SetBinContent(5,0.007980089);
   ttH_Hbb_ptgg__32->SetBinContent(6,0.007923088);
   ttH_Hbb_ptgg__32->SetBinContent(7,0.007524084);
   ttH_Hbb_ptgg__32->SetBinContent(8,0.00809409);
   ttH_Hbb_ptgg__32->SetBinContent(9,0.007125079);
   ttH_Hbb_ptgg__32->SetBinError(1,0.0005034153);
   ttH_Hbb_ptgg__32->SetBinError(2,0.0005526409);
   ttH_Hbb_ptgg__32->SetBinError(3,0.0005784925);
   ttH_Hbb_ptgg__32->SetBinError(4,0.0005642767);
   ttH_Hbb_ptgg__32->SetBinError(5,0.0006744397);
   ttH_Hbb_ptgg__32->SetBinError(6,0.0006720267);
   ttH_Hbb_ptgg__32->SetBinError(7,0.0006548865);
   ttH_Hbb_ptgg__32->SetBinError(8,0.00067924);
   ttH_Hbb_ptgg__32->SetBinError(9,0.0006372856);
   ttH_Hbb_ptgg__32->SetEntries(1051);
