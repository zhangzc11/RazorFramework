void ptgg_Hbb_Mr250Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:17:23 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-5.011541,762.1687,-1.307837);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.03023729);
   
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",70,20,720);
   hs_stack_8->SetMinimum(0.1350856);
   hs_stack_8->SetMaximum(0.0270959);
   ...
   vH_Hbb_ptgg__31->SetBinContent(9,0.0005157039);
   vH_Hbb_ptgg__31->SetBinError(9,0.0003646577);
   vH_Hbb_ptgg__31->SetEntries(2);
   ...
   ttH_Hbb_ptgg__32->SetBinContent(1,0.001311013);
   ttH_Hbb_ptgg__32->SetBinContent(2,0.001710017);
   ttH_Hbb_ptgg__32->SetBinContent(3,0.001995019);
   ttH_Hbb_ptgg__32->SetBinContent(4,0.001596016);
   ttH_Hbb_ptgg__32->SetBinContent(5,0.002565026);
   ttH_Hbb_ptgg__32->SetBinContent(6,0.002622027);
   ttH_Hbb_ptgg__32->SetBinContent(7,0.002850029);
   ttH_Hbb_ptgg__32->SetBinContent(8,0.002508025);
   ttH_Hbb_ptgg__32->SetBinContent(9,0.002508025);
   ttH_Hbb_ptgg__32->SetBinError(1,0.0002733651);
   ttH_Hbb_ptgg__32->SetBinError(2,0.0003122049);
   ttH_Hbb_ptgg__32->SetBinError(3,0.0003372198);
   ttH_Hbb_ptgg__32->SetBinError(4,0.0003016186);
   ttH_Hbb_ptgg__32->SetBinError(5,0.0003823714);
   ttH_Hbb_ptgg__32->SetBinError(6,0.0003865966);
   ttH_Hbb_ptgg__32->SetBinError(7,0.0004030548);
   ttH_Hbb_ptgg__32->SetBinError(8,0.0003780989);
   ttH_Hbb_ptgg__32->SetBinError(9,0.0003780989);
   ttH_Hbb_ptgg__32->SetEntries(345);
