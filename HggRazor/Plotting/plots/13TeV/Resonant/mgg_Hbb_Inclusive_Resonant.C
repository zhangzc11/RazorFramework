...
//=========  (Sun Jun  7 09:12:35 2015) by ROOT version6.03/05
   ...
   c->Range(94.75904,-0.01103877,163.4337,0.08095099);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   ggH_Hbb_mgg__25->SetBinContent(14,0.005047461);
   ggH_Hbb_mgg__25->SetBinContent(15,0.005047461);
   ggH_Hbb_mgg__25->SetBinContent(16,0.005047461);
   ggH_Hbb_mgg__25->SetBinError(14,0.005047461);
   ggH_Hbb_mgg__25->SetBinError(15,0.005047461);
   ggH_Hbb_mgg__25->SetBinError(16,0.005047461);
   ...
   vH_Hbb_mgg__27->SetBinContent(12,0.000257852);
   vH_Hbb_mgg__27->SetBinContent(13,0.000257852);
   vH_Hbb_mgg__27->SetBinContent(14,0.00128926);
   vH_Hbb_mgg__27->SetBinContent(15,0.001804964);
   vH_Hbb_mgg__27->SetBinContent(16,0.0005157039);
   vH_Hbb_mgg__27->SetBinError(12,0.000257852);
   vH_Hbb_mgg__27->SetBinError(13,0.000257852);
   vH_Hbb_mgg__27->SetBinError(14,0.0005765745);
   vH_Hbb_mgg__27->SetBinError(15,0.0006822122);
   vH_Hbb_mgg__27->SetBinError(16,0.0003646577);
   vH_Hbb_mgg__27->SetEntries(16);
   ...
   ttH_Hbb_mgg__28->SetBinContent(2,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(3,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(4,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(5,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(6,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(7,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(8,0.0002280022);
   ttH_Hbb_mgg__28->SetBinContent(9,0.0004560044);
   ttH_Hbb_mgg__28->SetBinContent(10,0.0003420033);
   ttH_Hbb_mgg__28->SetBinContent(11,0.0007980078);
   ttH_Hbb_mgg__28->SetBinContent(12,0.001596016);
   ttH_Hbb_mgg__28->SetBinContent(13,0.002736028);
   ttH_Hbb_mgg__28->SetBinContent(14,0.01499117);
   ttH_Hbb_mgg__28->SetBinContent(15,0.02730331);
   ttH_Hbb_mgg__28->SetBinContent(16,0.008208091);
   ttH_Hbb_mgg__28->SetBinContent(17,0.00102601);
   ttH_Hbb_mgg__28->SetBinContent(18,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(19,0.0002280022);
   ttH_Hbb_mgg__28->SetBinContent(20,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(21,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(25,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(26,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(38,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(39,0.0005700056);
   ttH_Hbb_mgg__28->SetBinError(1,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(2,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(3,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(4,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(5,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(6,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(7,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(8,0.0001140011);
   ttH_Hbb_mgg__28->SetBinError(9,0.0001612219);
   ttH_Hbb_mgg__28->SetBinError(10,0.0001396223);
   ttH_Hbb_mgg__28->SetBinError(11,0.0002132766);
   ttH_Hbb_mgg__28->SetBinError(12,0.0003016186);
   ttH_Hbb_mgg__28->SetBinError(13,0.0003949114);
   ttH_Hbb_mgg__28->SetBinError(14,0.0009243937);
   ttH_Hbb_mgg__28->SetBinError(15,0.001247518);
   ttH_Hbb_mgg__28->SetBinError(16,0.0006840067);
   ttH_Hbb_mgg__28->SetBinError(17,0.0002418329);
   ttH_Hbb_mgg__28->SetBinError(18,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(19,0.0001140011);
   ttH_Hbb_mgg__28->SetBinError(20,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(21,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(25,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(26,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(38,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(39,0.0001802516);
   ttH_Hbb_mgg__28->SetEntries(1051);
