void rsq_Zbb_Mr250Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:17:23 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-4.636738,1.060241,-0.9330347);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.06657775);
   
   TH1F *hs_stack_10 = new TH1F("hs_stack_10","",125,0,5);
   hs_stack_10->SetMinimum(0.1096895);
   hs_stack_10->SetMaximum(0.06422528);
   ...
   ttH_Zbb_rsq__40->SetBinContent(2,0.005700062);
   ...
   ttH_Zbb_rsq__40->SetBinError(2,0.0005700056);
   ...
   ttH_Zbb_rsq__40->SetEntries(243);
