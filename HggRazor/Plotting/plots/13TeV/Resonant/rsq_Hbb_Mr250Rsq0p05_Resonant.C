void rsq_Hbb_Mr250Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun  7 09:17:23 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-4.646064,1.060241,-0.9423599);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.06527921);
   
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",125,0,5);
   hs_stack_6->SetMinimum(0.1102065);
   hs_stack_6->SetMaximum(0.06286094);
   ...
   ttH_Hbb_rsq__24->SetBinContent(2,0.006270069);
   ...
   ttH_Hbb_rsq__24->SetBinError(2,0.0005978269);
   ...
   ttH_Hbb_rsq__24->SetEntries(345);
