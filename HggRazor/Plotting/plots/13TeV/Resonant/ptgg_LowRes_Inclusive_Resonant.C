...
//=========  (Sun Jun  7 09:12:36 2015) by ROOT version6.03/05
   ...
   c->Range(-81.20482,-1.753274,762.1687,1.733688);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(21.07815);
   
   TH1F *hs_stack_20 = new TH1F("hs_stack_20","",70,20,720);
   hs_stack_20->SetMinimum(0.04625526);
   hs_stack_20->SetMaximum(30.87457);
   ...
   ggH_LowRes_ptgg__77->SetBinContent(1,1.362811);
   ggH_LowRes_ptgg__77->SetBinContent(2,1.711085);
   ggH_LowRes_ptgg__77->SetBinContent(3,1.781749);
   ggH_LowRes_ptgg__77->SetBinContent(4,1.771654);
   ggH_LowRes_ptgg__77->SetBinContent(5,1.448618);
   ggH_LowRes_ptgg__77->SetBinContent(6,1.191198);
   ggH_LowRes_ptgg__77->SetBinContent(7,0.9943482);
   ggH_LowRes_ptgg__77->SetBinContent(8,0.7116915);
   ggH_LowRes_ptgg__77->SetBinContent(9,0.7369287);
   ggH_LowRes_ptgg__77->SetBinError(1,0.08293826);
   ggH_LowRes_ptgg__77->SetBinError(2,0.09293362);
   ggH_LowRes_ptgg__77->SetBinError(3,0.09483319);
   ggH_LowRes_ptgg__77->SetBinError(4,0.09456416);
   ggH_LowRes_ptgg__77->SetBinError(5,0.08550942);
   ggH_LowRes_ptgg__77->SetBinError(6,0.07754057);
   ggH_LowRes_ptgg__77->SetBinError(7,0.0708445);
   ggH_LowRes_ptgg__77->SetBinError(8,0.05993528);
   ggH_LowRes_ptgg__77->SetBinError(9,0.06098871);
   ggH_LowRes_ptgg__77->SetEntries(2320);
   ...
   vbfH_LowRes_ptgg__78->SetBinContent(1,0.1339284);
   vbfH_LowRes_ptgg__78->SetBinContent(2,0.1648693);
   vbfH_LowRes_ptgg__78->SetBinContent(3,0.2152588);
   vbfH_LowRes_ptgg__78->SetBinContent(4,0.2157008);
   vbfH_LowRes_ptgg__78->SetBinContent(5,0.2444317);
   vbfH_LowRes_ptgg__78->SetBinContent(6,0.2289612);
   vbfH_LowRes_ptgg__78->SetBinContent(7,0.2064185);
   vbfH_LowRes_ptgg__78->SetBinContent(8,0.1997883);
   vbfH_LowRes_ptgg__78->SetBinContent(9,0.1776877);
   vbfH_LowRes_ptgg__78->SetBinError(1,0.007693997);
   vbfH_LowRes_ptgg__78->SetBinError(2,0.008536604);
   vbfH_LowRes_ptgg__78->SetBinError(3,0.009754279);
   vbfH_LowRes_ptgg__78->SetBinError(4,0.009764289);
   vbfH_LowRes_ptgg__78->SetBinError(5,0.01039425);
   vbfH_LowRes_ptgg__78->SetBinError(6,0.01005994);
   vbfH_LowRes_ptgg__78->SetBinError(7,0.009551886);
   vbfH_LowRes_ptgg__78->SetBinError(8,0.009397231);
   vbfH_LowRes_ptgg__78->SetBinError(9,0.008862244);
   vbfH_LowRes_ptgg__78->SetEntries(4043);
   ...
   vH_LowRes_ptgg__79->SetBinContent(1,0.06987796);
   vH_LowRes_ptgg__79->SetBinContent(2,0.08895884);
   vH_LowRes_ptgg__79->SetBinContent(3,0.09746788);
   vH_LowRes_ptgg__79->SetBinContent(4,0.1070083);
   vH_LowRes_ptgg__79->SetBinContent(5,0.1018513);
   vH_LowRes_ptgg__79->SetBinContent(6,0.1021092);
   vH_LowRes_ptgg__79->SetBinContent(7,0.09076378);
   vH_LowRes_ptgg__79->SetBinContent(8,0.07219861);
   vH_LowRes_ptgg__79->SetBinContent(9,0.06678376);
   vH_LowRes_ptgg__79->SetBinError(1,0.004244779);
   vH_LowRes_ptgg__79->SetBinError(2,0.004789388);
   vH_LowRes_ptgg__79->SetBinError(3,0.005013215);
   vH_LowRes_ptgg__79->SetBinError(4,0.005252844);
   vH_LowRes_ptgg__79->SetBinError(5,0.005124706);
   vH_LowRes_ptgg__79->SetBinError(6,0.005131189);
   vH_LowRes_ptgg__79->SetBinError(7,0.004837732);
   vH_LowRes_ptgg__79->SetBinError(8,0.004314689);
   vH_LowRes_ptgg__79->SetBinError(9,0.004149735);
   vH_LowRes_ptgg__79->SetEntries(3091);
   ...
   ttH_LowRes_ptgg__80->SetBinContent(1,0.00723908);
   ttH_LowRes_ptgg__80->SetBinContent(2,0.009063101);
   ttH_LowRes_ptgg__80->SetBinContent(3,0.01134313);
   ttH_LowRes_ptgg__80->SetBinContent(4,0.01345215);
   ttH_LowRes_ptgg__80->SetBinContent(5,0.01578918);
   ttH_LowRes_ptgg__80->SetBinContent(6,0.01305315);
   ttH_LowRes_ptgg__80->SetBinContent(7,0.01322415);
   ttH_LowRes_ptgg__80->SetBinContent(8,0.01134313);
   ttH_LowRes_ptgg__80->SetBinContent(9,0.01128613);
   ttH_LowRes_ptgg__80->SetBinError(1,0.0006423637);
   ttH_LowRes_ptgg__80->SetBinError(2,0.0007187497);
   ttH_LowRes_ptgg__80->SetBinError(3,0.0008040918);
   ttH_LowRes_ptgg__80->SetBinError(4,0.0008756592);
   ttH_LowRes_ptgg__80->SetBinError(5,0.0009486783);
   ttH_LowRes_ptgg__80->SetBinError(6,0.000862575);
   ttH_LowRes_ptgg__80->SetBinError(7,0.0008682066);
   ttH_LowRes_ptgg__80->SetBinError(8,0.0008040918);
   ttH_LowRes_ptgg__80->SetBinError(9,0.0008020689);
   ttH_LowRes_ptgg__80->SetEntries(1856);
