void mr_Zbb_Mr250_Rsq0p05_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:15:48 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-5.282555,2147.47,-1.578852);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.01714345);
   
   TH1F *hs_stack_9 = new TH1F("hs_stack_9","",160,130,8130);
   hs_stack_9->SetMinimum(0.1620617);
   hs_stack_9->SetMaximum(0.01451741);
   ...
   vH_Zbb_mr__53->SetBinContent(3,7.436967e-05);
   vH_Zbb_mr__53->SetBinContent(4,7.436967e-05);
   vH_Zbb_mr__53->SetBinContent(5,7.436967e-05);
   vH_Zbb_mr__53->SetBinError(3,7.436966e-05);
   vH_Zbb_mr__53->SetBinError(4,7.436966e-05);
   vH_Zbb_mr__53->SetBinError(5,7.436966e-05);
   vH_Zbb_mr__53->SetEntries(3);
   ...
   ttH_Zbb_mr__54->SetBinContent(3,0.001331649);
   ttH_Zbb_mr__54->SetBinContent(4,0.001545371);
   ttH_Zbb_mr__54->SetBinContent(5,0.001512491);
   ttH_Zbb_mr__54->SetBinContent(6,0.0008384456);
   ...
   ttH_Zbb_mr__54->SetBinError(3,0.0001479609);
   ttH_Zbb_mr__54->SetBinError(4,0.0001593927);
   ttH_Zbb_mr__54->SetBinError(5,0.0001576879);
   ttH_Zbb_mr__54->SetBinError(6,0.0001174058);
