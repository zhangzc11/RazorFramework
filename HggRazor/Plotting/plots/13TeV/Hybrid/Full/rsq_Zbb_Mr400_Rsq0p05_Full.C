void rsq_Zbb_Mr400_Rsq0p05_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:14:14 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-5.453609,1.060241,-1.749905);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.01200128);
   
   TH1F *hs_stack_10 = new TH1F("hs_stack_10","",125,0,5);
   hs_stack_10->SetMinimum(0.1853177);
   hs_stack_10->SetMaximum(0.009791195);
   ...
   ttH_Zbb_rsq__60->SetBinContent(2,0.001200128);
   ttH_Zbb_rsq__60->SetBinContent(3,0.0005096431);
   ttH_Zbb_rsq__60->SetBinContent(4,0.0003123619);
   ttH_Zbb_rsq__60->SetBinContent(5,0.0001315208);
   ttH_Zbb_rsq__60->SetBinContent(6,8.22005e-05);
   ttH_Zbb_rsq__60->SetBinContent(7,3.28802e-05);
   ttH_Zbb_rsq__60->SetBinContent(8,3.28802e-05);
   ttH_Zbb_rsq__60->SetBinError(2,0.0001404643);
   ttH_Zbb_rsq__60->SetBinError(3,9.153461e-05);
   ttH_Zbb_rsq__60->SetBinError(4,7.166074e-05);
   ttH_Zbb_rsq__60->SetBinError(5,4.649963e-05);
   ttH_Zbb_rsq__60->SetBinError(6,3.676118e-05);
   ttH_Zbb_rsq__60->SetBinError(7,2.324981e-05);
   ttH_Zbb_rsq__60->SetBinError(8,2.324981e-05);
   ttH_Zbb_rsq__60->SetEntries(140);
