void ptgg_Hbb_Mr400_Rsq0p05_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:14:14 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-5.768436,762.1687,-2.064732);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.006247239);
   
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",70,20,720);
   hs_stack_8->SetMinimum(0.2513548);
   hs_stack_8->SetMaximum(0.004742514);
   ...
   ttH_Hbb_ptgg__48->SetBinContent(1,0.000164401);
   ttH_Hbb_ptgg__48->SetBinContent(2,0.0001972812);
   ttH_Hbb_ptgg__48->SetBinContent(3,0.0002630416);
   ttH_Hbb_ptgg__48->SetBinContent(4,0.000164401);
   ttH_Hbb_ptgg__48->SetBinContent(5,0.0003616822);
   ttH_Hbb_ptgg__48->SetBinContent(6,0.0005096431);
   ttH_Hbb_ptgg__48->SetBinContent(7,0.0004603228);
   ttH_Hbb_ptgg__48->SetBinContent(8,0.0006247239);
   ttH_Hbb_ptgg__48->SetBinContent(9,0.0004603228);
   ttH_Hbb_ptgg__48->SetBinError(1,5.198816e-05);
   ttH_Hbb_ptgg__48->SetBinError(2,5.695018e-05);
   ttH_Hbb_ptgg__48->SetBinError(3,6.57604e-05);
   ttH_Hbb_ptgg__48->SetBinError(4,5.198816e-05);
   ttH_Hbb_ptgg__48->SetBinError(5,7.711091e-05);
   ttH_Hbb_ptgg__48->SetBinError(6,9.153461e-05);
   ttH_Hbb_ptgg__48->SetBinError(7,8.699284e-05);
   ttH_Hbb_ptgg__48->SetBinError(8,0.0001013436);
   ttH_Hbb_ptgg__48->SetBinError(9,8.699284e-05);
   ttH_Hbb_ptgg__48->SetEntries(195);
