void ptgg_Hbb_Mr350_Rsq0p035_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:16:18 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-5.421785,762.1687,-1.718081);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.01282329);
   
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",70,20,720);
   hs_stack_8->SetMinimum(0.1805055);
   hs_stack_8->SetMaximum(0.01053561);
   ...
   ttH_Hbb_ptgg__48->SetBinContent(1,0.0003452421);
   ttH_Hbb_ptgg__48->SetBinContent(2,0.0005096431);
   ttH_Hbb_ptgg__48->SetBinContent(3,0.0006576041);
   ttH_Hbb_ptgg__48->SetBinContent(4,0.0005425233);
   ttH_Hbb_ptgg__48->SetBinContent(5,0.000772685);
   ttH_Hbb_ptgg__48->SetBinContent(6,0.0009864068);
   ttH_Hbb_ptgg__48->SetBinContent(7,0.001035727);
   ttH_Hbb_ptgg__48->SetBinContent(8,0.001282329);
   ttH_Hbb_ptgg__48->SetBinContent(9,0.001019287);
   ttH_Hbb_ptgg__48->SetBinError(1,7.533801e-05);
   ttH_Hbb_ptgg__48->SetBinError(2,9.153461e-05);
   ttH_Hbb_ptgg__48->SetBinError(3,0.0001039763);
   ttH_Hbb_ptgg__48->SetBinError(4,9.444119e-05);
   ttH_Hbb_ptgg__48->SetBinError(5,0.0001127077);
   ttH_Hbb_ptgg__48->SetBinError(6,0.0001273445);
   ttH_Hbb_ptgg__48->SetBinError(7,0.0001304893);
   ttH_Hbb_ptgg__48->SetBinError(8,0.000145195);
   ttH_Hbb_ptgg__48->SetBinError(9,0.0001294495);
   ttH_Hbb_ptgg__48->SetEntries(435);
