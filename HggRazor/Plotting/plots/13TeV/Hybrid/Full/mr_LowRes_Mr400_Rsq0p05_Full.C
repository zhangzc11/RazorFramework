void mr_LowRes_Mr400_Rsq0p05_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:14:16 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-4.702623,2147.47,-0.9989194);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.05793196);
   
   TH1F *hs_stack_17 = new TH1F("hs_stack_17","",160,130,8130);
   hs_stack_17->SetMinimum(0.1134483);
   hs_stack_17->SetMaximum(0.05518504);
   ...
   vH_LowRes_mr__101->SetBinContent(6,0.000378372);
   ...
   vH_LowRes_mr__101->SetBinError(6,0.000189186);
   ...
   vH_LowRes_mr__101->SetEntries(14);
   ...
   ttH_LowRes_mr__102->SetBinContent(6,0.00125464);
   ...
   ttH_LowRes_mr__102->SetBinError(6,0.0001619732);
   ...
   ttH_LowRes_mr__102->SetEntries(379);
