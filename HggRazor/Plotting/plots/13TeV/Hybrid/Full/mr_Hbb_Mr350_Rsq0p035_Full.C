void mr_Hbb_Mr350_Rsq0p035_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:16:18 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-5.312297,2147.47,-1.608594);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.01611132);
   
   TH1F *hs_stack_5 = new TH1F("hs_stack_5","",160,130,8130);
   hs_stack_5->SetMinimum(0.1656821);
   hs_stack_5->SetMaximum(0.01355648);
   ...
   ttH_Hbb_mr__30->SetBinContent(5,0.00139741);
   ttH_Hbb_mr__30->SetBinContent(6,0.001611132);
   ttH_Hbb_mr__30->SetBinContent(7,0.001265889);
   ttH_Hbb_mr__30->SetBinContent(8,0.0008055653);
   ttH_Hbb_mr__30->SetBinContent(9,0.0007069245);
   ttH_Hbb_mr__30->SetBinContent(10,0.0003616822);
   ttH_Hbb_mr__30->SetBinContent(11,0.0002466015);
   ttH_Hbb_mr__30->SetBinContent(12,0.0002301614);
   ttH_Hbb_mr__30->SetBinContent(13,0.000164401);
   ttH_Hbb_mr__30->SetBinContent(14,0.0001315208);
   ttH_Hbb_mr__30->SetBinContent(15,4.93203e-05);
   ttH_Hbb_mr__30->SetBinContent(16,1.64401e-05);
   ttH_Hbb_mr__30->SetBinContent(18,1.64401e-05);
   ttH_Hbb_mr__30->SetBinContent(19,3.28802e-05);
   ttH_Hbb_mr__30->SetBinContent(20,1.64401e-05);
   ttH_Hbb_mr__30->SetBinContent(21,4.93203e-05);
   ttH_Hbb_mr__30->SetBinContent(23,1.64401e-05);
   ttH_Hbb_mr__30->SetBinContent(26,3.28802e-05);
   ttH_Hbb_mr__30->SetBinError(5,0.0001515702);
   ttH_Hbb_mr__30->SetBinError(6,0.0001627487);
   ttH_Hbb_mr__30->SetBinError(7,0.0001442613);
   ttH_Hbb_mr__30->SetBinError(8,0.0001150807);
   ttH_Hbb_mr__30->SetBinError(9,0.0001078049);
   ttH_Hbb_mr__30->SetBinError(10,7.711091e-05);
   ttH_Hbb_mr__30->SetBinError(11,6.367224e-05);
   ttH_Hbb_mr__30->SetBinError(12,6.151322e-05);
   ttH_Hbb_mr__30->SetBinError(13,5.198816e-05);
   ttH_Hbb_mr__30->SetBinError(14,4.649963e-05);
   ttH_Hbb_mr__30->SetBinError(15,2.847509e-05);
   ttH_Hbb_mr__30->SetBinError(16,1.64401e-05);
   ttH_Hbb_mr__30->SetBinError(18,1.64401e-05);
   ttH_Hbb_mr__30->SetBinError(19,2.324981e-05);
   ttH_Hbb_mr__30->SetBinError(20,1.64401e-05);
   ttH_Hbb_mr__30->SetBinError(21,2.847509e-05);
   ttH_Hbb_mr__30->SetBinError(23,1.64401e-05);
   ttH_Hbb_mr__30->SetBinError(26,2.324981e-05);
   ttH_Hbb_mr__30->SetEntries(435);
