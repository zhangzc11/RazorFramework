void ptgg_Zbb_Mr250_Rsq0p05_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:15:48 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-5.494841,762.1687,-1.791137);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.01101488);
   
   TH1F *hs_stack_12 = new TH1F("hs_stack_12","",70,20,720);
   hs_stack_12->SetMinimum(0.1919423);
   hs_stack_12->SetMaximum(0.008904381);
   ...
   vH_Zbb_ptgg__71->SetBinContent(4,7.436967e-05);
   vH_Zbb_ptgg__71->SetBinContent(6,7.436967e-05);
   vH_Zbb_ptgg__71->SetBinContent(9,7.436967e-05);
   vH_Zbb_ptgg__71->SetBinError(4,7.436966e-05);
   vH_Zbb_ptgg__71->SetBinError(6,7.436966e-05);
   vH_Zbb_ptgg__71->SetBinError(9,7.436966e-05);
   vH_Zbb_ptgg__71->SetEntries(3);
   ...
   ttH_Zbb_ptgg__72->SetBinContent(1,0.0002794817);
   ttH_Zbb_ptgg__72->SetBinContent(2,0.0004603228);
   ttH_Zbb_ptgg__72->SetBinContent(3,0.0007069245);
   ttH_Zbb_ptgg__72->SetBinContent(4,0.0009864068);
   ttH_Zbb_ptgg__72->SetBinContent(5,0.0008713258);
   ttH_Zbb_ptgg__72->SetBinContent(6,0.000887766);
   ttH_Zbb_ptgg__72->SetBinContent(7,0.0009042061);
   ttH_Zbb_ptgg__72->SetBinContent(8,0.001101488);
   ttH_Zbb_ptgg__72->SetBinContent(9,0.0008548857);
   ttH_Zbb_ptgg__72->SetBinError(1,6.778427e-05);
   ttH_Zbb_ptgg__72->SetBinError(2,8.699284e-05);
   ttH_Zbb_ptgg__72->SetBinError(3,0.0001078049);
   ttH_Zbb_ptgg__72->SetBinError(4,0.0001273445);
   ttH_Zbb_ptgg__72->SetBinError(5,0.0001196857);
   ttH_Zbb_ptgg__72->SetBinError(6,0.0001208096);
   ttH_Zbb_ptgg__72->SetBinError(7,0.000121923);
   ttH_Zbb_ptgg__72->SetBinError(8,0.000134568);
   ttH_Zbb_ptgg__72->SetBinError(9,0.0001185513);
   ttH_Zbb_ptgg__72->SetEntries(429);
