void ptgg_Hbb_Mr200_Rsq0p02_Full()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:16:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-1.648582,762.1687,1.295952);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(8.851291);
   
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",70,20,720);
   hs_stack_8->SetMinimum(0.05067131);
   hs_stack_8->SetMaximum(12.298);
   ...
   gammaJet_Hbb_ptgg__43->SetBinContent(2,0.1151994);
   gammaJet_Hbb_ptgg__43->SetBinContent(8,0.1151994);
   gammaJet_Hbb_ptgg__43->SetBinContent(9,0.1151994);
   gammaJet_Hbb_ptgg__43->SetBinError(2,0.1151994);
   gammaJet_Hbb_ptgg__43->SetBinError(8,0.1151994);
   gammaJet_Hbb_ptgg__43->SetBinError(9,0.1151994);
   gammaJet_Hbb_ptgg__43->SetEntries(3);
   ...
   diphoton_Hbb_ptgg__44->SetBinContent(1,0.1921166);
   diphoton_Hbb_ptgg__44->SetBinContent(2,0.7684665);
   diphoton_Hbb_ptgg__44->SetBinContent(3,0.1921166);
   diphoton_Hbb_ptgg__44->SetBinContent(8,0.1921166);
   diphoton_Hbb_ptgg__44->SetBinError(1,0.1921166);
   diphoton_Hbb_ptgg__44->SetBinError(2,0.3842333);
   diphoton_Hbb_ptgg__44->SetBinError(3,0.1921166);
   diphoton_Hbb_ptgg__44->SetBinError(8,0.1921166);
   diphoton_Hbb_ptgg__44->SetEntries(7);
   ...
   ggH_Hbb_ptgg__45->SetBinContent(1,0.001444156);
   ggH_Hbb_ptgg__45->SetBinError(1,0.001444156);
   ggH_Hbb_ptgg__45->SetEntries(1);
   ...
   vbfH_Hbb_ptgg__46->SetBinContent(6,0.0001274841);
   vbfH_Hbb_ptgg__46->SetBinContent(7,0.0001274841);
   vbfH_Hbb_ptgg__46->SetBinError(6,0.0001274841);
   vbfH_Hbb_ptgg__46->SetBinError(7,0.0001274841);
   vbfH_Hbb_ptgg__46->SetEntries(2);
   ...
   vH_Hbb_ptgg__47->SetBinContent(1,7.436967e-05);
   vH_Hbb_ptgg__47->SetBinContent(4,0.000223109);
   vH_Hbb_ptgg__47->SetBinContent(6,7.436967e-05);
   vH_Hbb_ptgg__47->SetBinContent(7,7.436967e-05);
   vH_Hbb_ptgg__47->SetBinContent(8,7.436967e-05);
   vH_Hbb_ptgg__47->SetBinContent(9,0.0002974787);
   vH_Hbb_ptgg__47->SetBinError(1,7.436966e-05);
   vH_Hbb_ptgg__47->SetBinError(4,0.000128812);
   vH_Hbb_ptgg__47->SetBinError(6,7.436966e-05);
   vH_Hbb_ptgg__47->SetBinError(7,7.436966e-05);
   vH_Hbb_ptgg__47->SetBinError(8,7.436966e-05);
   vH_Hbb_ptgg__47->SetBinError(9,0.0001487393);
   vH_Hbb_ptgg__47->SetEntries(11);
   ...
   ttH_Hbb_ptgg__48->SetBinContent(1,0.001282329);
   ttH_Hbb_ptgg__48->SetBinContent(2,0.001463171);
   ttH_Hbb_ptgg__48->SetBinContent(3,0.001989255);
   ttH_Hbb_ptgg__48->SetBinContent(4,0.001874174);
   ttH_Hbb_ptgg__48->SetBinContent(5,0.002466019);
   ttH_Hbb_ptgg__48->SetBinContent(6,0.002515339);
   ttH_Hbb_ptgg__48->SetBinContent(7,0.002745501);
   ttH_Hbb_ptgg__48->SetBinContent(8,0.002909902);
   ttH_Hbb_ptgg__48->SetBinContent(9,0.002466019);
   ttH_Hbb_ptgg__48->SetBinError(1,0.000145195);
   ttH_Hbb_ptgg__48->SetBinError(2,0.0001550956);
   ttH_Hbb_ptgg__48->SetBinError(3,0.0001808411);
   ttH_Hbb_ptgg__48->SetBinError(4,0.0001755322);
   ttH_Hbb_ptgg__48->SetBinError(5,0.0002013493);
   ttH_Hbb_ptgg__48->SetBinError(6,0.0002033528);
   ttH_Hbb_ptgg__48->SetBinError(7,0.0002124529);
   ttH_Hbb_ptgg__48->SetBinError(8,0.0002187213);
   ttH_Hbb_ptgg__48->SetBinError(9,0.0002013493);
   ttH_Hbb_ptgg__48->SetEntries(1199);
