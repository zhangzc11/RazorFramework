void ptgg_Hbb_Mr250_Rsq0p02_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:10:03 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-4.446907,762.1687,-0.7432036);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.0994796);
   
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",70,20,720);
   hs_stack_8->SetMinimum(0.1001134);
   hs_stack_8->SetMaximum(0.09943452);
   ...
   vbfH_Hbb_ptgg__30->SetBinContent(7,0.0004420086);
   vbfH_Hbb_ptgg__30->SetBinError(7,0.0004420086);
   ...
   ttH_Hbb_ptgg__32->SetBinContent(1,0.003306035);
   ttH_Hbb_ptgg__32->SetBinContent(2,0.004446048);
   ttH_Hbb_ptgg__32->SetBinContent(3,0.005586061);
   ttH_Hbb_ptgg__32->SetBinContent(4,0.00552906);
   ttH_Hbb_ptgg__32->SetBinContent(5,0.007467083);
   ttH_Hbb_ptgg__32->SetBinContent(6,0.007866087);
   ttH_Hbb_ptgg__32->SetBinContent(7,0.008379093);
   ttH_Hbb_ptgg__32->SetBinContent(8,0.009690109);
   ttH_Hbb_ptgg__32->SetBinContent(9,0.00809409);
   ttH_Hbb_ptgg__32->SetBinError(1,0.0004341033);
   ttH_Hbb_ptgg__32->SetBinError(2,0.0005034153);
   ttH_Hbb_ptgg__32->SetBinError(3,0.0005642767);
   ttH_Hbb_ptgg__32->SetBinError(4,0.0005613904);
   ttH_Hbb_ptgg__32->SetBinError(5,0.0006524012);
   ttH_Hbb_ptgg__32->SetBinError(6,0.0006696049);
   ttH_Hbb_ptgg__32->SetBinError(7,0.000691095);
   ttH_Hbb_ptgg__32->SetBinError(8,0.0007431963);
   ttH_Hbb_ptgg__32->SetBinError(9,0.00067924);
   ttH_Hbb_ptgg__32->SetEntries(1059);
