void mgg_Hbb_Mr250_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:22 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(94.75904,-0.004070266,163.4337,0.02984862);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   vH_Hbb_mgg__27->SetBinContent(14,0.0005157039);
   vH_Hbb_mgg__27->SetBinContent(15,0.000257852);
   vH_Hbb_mgg__27->SetBinError(7,0.000257852);
   vH_Hbb_mgg__27->SetBinError(14,0.0003646577);
   vH_Hbb_mgg__27->SetBinError(15,0.000257852);
   vH_Hbb_mgg__27->SetEntries(4);
   ...
   ttH_Hbb_mgg__28->SetBinContent(3,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(4,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(5,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(6,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(7,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(8,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(9,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(10,0.000513005);
   ttH_Hbb_mgg__28->SetBinContent(11,0.0006840067);
   ttH_Hbb_mgg__28->SetBinContent(12,0.0008550083);
   ttH_Hbb_mgg__28->SetBinContent(13,0.002622027);
   ttH_Hbb_mgg__28->SetBinContent(14,0.008151091);
   ttH_Hbb_mgg__28->SetBinContent(15,0.01282515);
   ttH_Hbb_mgg__28->SetBinContent(16,0.004389047);
   ttH_Hbb_mgg__28->SetBinContent(17,0.0004560044);
   ttH_Hbb_mgg__28->SetBinContent(18,0.0002280022);
   ttH_Hbb_mgg__28->SetBinContent(19,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(20,0.0001710017);
   ttH_Hbb_mgg__28->SetBinContent(21,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(24,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(26,0.0002850028);
   ttH_Hbb_mgg__28->SetBinContent(28,5.700056e-05);
   ...
   ttH_Hbb_mgg__28->SetBinContent(33,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(34,0.0002280022);
   ttH_Hbb_mgg__28->SetBinContent(35,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(36,0.0001140011);
   ttH_Hbb_mgg__28->SetBinContent(37,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinContent(38,0.0001710017);
   ttH_Hbb_mgg__28->SetBinError(1,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(3,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(4,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(5,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(6,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(7,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(8,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(9,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(10,0.0001710017);
   ttH_Hbb_mgg__28->SetBinError(11,0.0001974557);
   ttH_Hbb_mgg__28->SetBinError(12,0.0002207622);
   ttH_Hbb_mgg__28->SetBinError(13,0.0003865966);
   ttH_Hbb_mgg__28->SetBinError(14,0.0006816275);
   ttH_Hbb_mgg__28->SetBinError(15,0.0008550084);
   ttH_Hbb_mgg__28->SetBinError(16,0.0005001779);
   ttH_Hbb_mgg__28->SetBinError(17,0.0001612219);
   ttH_Hbb_mgg__28->SetBinError(18,0.0001140011);
   ttH_Hbb_mgg__28->SetBinError(19,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(20,9.872786e-05);
   ttH_Hbb_mgg__28->SetBinError(21,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(24,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(26,0.0001274571);
   ttH_Hbb_mgg__28->SetBinError(28,5.700056e-05);
   ...
   ttH_Hbb_mgg__28->SetBinError(33,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(34,0.0001140011);
   ttH_Hbb_mgg__28->SetBinError(35,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(36,8.061096e-05);
   ttH_Hbb_mgg__28->SetBinError(37,5.700056e-05);
   ttH_Hbb_mgg__28->SetBinError(38,9.872786e-05);
   ttH_Hbb_mgg__28->SetEntries(587);
