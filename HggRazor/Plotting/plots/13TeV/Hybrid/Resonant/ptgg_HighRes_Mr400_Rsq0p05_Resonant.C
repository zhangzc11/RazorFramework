void ptgg_HighRes_Mr400_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-1.170519,762.1687,-0.4722579);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.2767386);
   
   TH1F *hs_stack_16 = new TH1F("hs_stack_16","",70,20,720);
   hs_stack_16->SetMinimum(0.08189774);
   hs_stack_16->SetMaximum(0.3012061);
   ...
   ggH_HighRes_ptgg__61->SetBinContent(1,0.00500713);
   ggH_HighRes_ptgg__61->SetBinContent(3,0.00500713);
   ggH_HighRes_ptgg__61->SetBinContent(7,0.00500713);
   ggH_HighRes_ptgg__61->SetBinContent(8,0.00500713);
   ggH_HighRes_ptgg__61->SetBinContent(9,0.02002852);
   ggH_HighRes_ptgg__61->SetBinError(1,0.00500713);
   ggH_HighRes_ptgg__61->SetBinError(3,0.00500713);
   ggH_HighRes_ptgg__61->SetBinError(7,0.00500713);
   ggH_HighRes_ptgg__61->SetBinError(8,0.00500713);
   ggH_HighRes_ptgg__61->SetBinError(9,0.01001426);
   ...
   vbfH_HighRes_ptgg__62->SetBinContent(5,0.0004420086);
   vbfH_HighRes_ptgg__62->SetBinContent(6,0.0004420086);
   vbfH_HighRes_ptgg__62->SetBinContent(7,0.0008840172);
   vbfH_HighRes_ptgg__62->SetBinContent(8,0.001326026);
   vbfH_HighRes_ptgg__62->SetBinContent(9,0.0008840172);
   vbfH_HighRes_ptgg__62->SetBinError(5,0.0004420086);
   vbfH_HighRes_ptgg__62->SetBinError(6,0.0004420086);
   vbfH_HighRes_ptgg__62->SetBinError(7,0.0006250945);
   vbfH_HighRes_ptgg__62->SetBinError(8,0.0007655813);
   vbfH_HighRes_ptgg__62->SetBinError(9,0.0006250945);
   vbfH_HighRes_ptgg__62->SetEntries(9);
   ...
   vH_HighRes_ptgg__63->SetBinContent(3,0.0007735559);
   vH_HighRes_ptgg__63->SetBinContent(4,0.0005157039);
   vH_HighRes_ptgg__63->SetBinContent(5,0.001031408);
   vH_HighRes_ptgg__63->SetBinContent(6,0.0007735559);
   vH_HighRes_ptgg__63->SetBinContent(7,0.000257852);
   vH_HighRes_ptgg__63->SetBinContent(8,0.0005157039);
   vH_HighRes_ptgg__63->SetBinContent(9,0.00128926);
   vH_HighRes_ptgg__63->SetBinError(2,0.000257852);
   vH_HighRes_ptgg__63->SetBinError(3,0.0004466127);
   vH_HighRes_ptgg__63->SetBinError(4,0.0003646577);
   vH_HighRes_ptgg__63->SetBinError(5,0.0005157039);
   vH_HighRes_ptgg__63->SetBinError(6,0.0004466127);
   vH_HighRes_ptgg__63->SetBinError(7,0.000257852);
   vH_HighRes_ptgg__63->SetBinError(8,0.0003646577);
   vH_HighRes_ptgg__63->SetBinError(9,0.0005765745);
   vH_HighRes_ptgg__63->SetEntries(21);
   ...
   ttH_HighRes_ptgg__64->SetBinContent(1,0.002280023);
   ttH_HighRes_ptgg__64->SetBinContent(2,0.002508025);
   ttH_HighRes_ptgg__64->SetBinContent(3,0.003591038);
   ttH_HighRes_ptgg__64->SetBinContent(4,0.003990042);
   ttH_HighRes_ptgg__64->SetBinContent(5,0.004389047);
   ttH_HighRes_ptgg__64->SetBinContent(6,0.005814064);
   ttH_HighRes_ptgg__64->SetBinContent(7,0.004902053);
   ttH_HighRes_ptgg__64->SetBinContent(8,0.005415059);
   ttH_HighRes_ptgg__64->SetBinContent(9,0.00547206);
   ttH_HighRes_ptgg__64->SetBinError(1,0.0003605032);
   ttH_HighRes_ptgg__64->SetBinError(2,0.0003780989);
   ttH_HighRes_ptgg__64->SetBinError(3,0.0004524279);
   ttH_HighRes_ptgg__64->SetBinError(4,0.0004769009);
   ttH_HighRes_ptgg__64->SetBinError(5,0.0005001779);
   ttH_HighRes_ptgg__64->SetBinError(6,0.0005756774);
   ttH_HighRes_ptgg__64->SetBinError(7,0.0005286014);
   ttH_HighRes_ptgg__64->SetBinError(8,0.0005555727);
   ttH_HighRes_ptgg__64->SetBinError(9,0.0005584891);
   ttH_HighRes_ptgg__64->SetEntries(673);
