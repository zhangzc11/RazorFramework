void ptgg_Hbb_Mr400_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-5.170696,762.1687,-1.466993);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.02166021);
   
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",70,20,720);
   hs_stack_8->SetMinimum(0.1497384);
   hs_stack_8->SetMaximum(0.01878228);
   ...
   ttH_Hbb_ptgg__32->SetBinContent(1,0.0005700056);
   ttH_Hbb_ptgg__32->SetBinContent(2,0.0006840067);
   ttH_Hbb_ptgg__32->SetBinContent(3,0.0009120089);
   ttH_Hbb_ptgg__32->SetBinContent(4,0.0005700056);
   ttH_Hbb_ptgg__32->SetBinContent(5,0.001254012);
   ttH_Hbb_ptgg__32->SetBinContent(6,0.001767017);
   ttH_Hbb_ptgg__32->SetBinContent(7,0.001596016);
   ttH_Hbb_ptgg__32->SetBinContent(8,0.002166021);
   ttH_Hbb_ptgg__32->SetBinContent(9,0.001596016);
   ttH_Hbb_ptgg__32->SetBinError(1,0.0001802516);
   ttH_Hbb_ptgg__32->SetBinError(2,0.0001974557);
   ttH_Hbb_ptgg__32->SetBinError(3,0.0002280022);
   ttH_Hbb_ptgg__32->SetBinError(4,0.0001802516);
   ttH_Hbb_ptgg__32->SetBinError(5,0.0002673563);
   ttH_Hbb_ptgg__32->SetBinError(6,0.0003173657);
   ttH_Hbb_ptgg__32->SetBinError(7,0.0003016186);
   ttH_Hbb_ptgg__32->SetBinError(8,0.000351375);
   ttH_Hbb_ptgg__32->SetBinError(9,0.0003016186);
   ttH_Hbb_ptgg__32->SetEntries(195);
