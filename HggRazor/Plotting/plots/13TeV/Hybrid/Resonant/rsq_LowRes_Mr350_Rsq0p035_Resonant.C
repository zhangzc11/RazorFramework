void rsq_LowRes_Mr350_Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:10:49 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.4004,1.060241,0.3278662);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(1.315726);
   
   TH1F *hs_stack_18 = new TH1F("hs_stack_18","",125,0,5);
   hs_stack_18->SetMinimum(0.06411972);
   hs_stack_18->SetMaximum(1.610228);
   ...
   ggH_LowRes_rsq__69->SetBinContent(1,0.04506417);
   ggH_LowRes_rsq__69->SetBinContent(2,0.09012835);
   ggH_LowRes_rsq__69->SetBinContent(3,0.00500713);
   ggH_LowRes_rsq__69->SetBinError(1,0.01502139);
   ggH_LowRes_rsq__69->SetBinError(2,0.02124345);
   ggH_LowRes_rsq__69->SetBinError(3,0.00500713);
   ggH_LowRes_rsq__69->SetEntries(28);
   ...
   vbfH_LowRes_rsq__70->SetBinContent(1,0.006630128);
   vbfH_LowRes_rsq__70->SetBinContent(2,0.01458628);
   vbfH_LowRes_rsq__70->SetBinContent(3,0.0004420086);
   vbfH_LowRes_rsq__70->SetBinError(1,0.001711892);
   vbfH_LowRes_rsq__70->SetBinError(2,0.002539146);
   vbfH_LowRes_rsq__70->SetBinError(3,0.0004420086);
   vbfH_LowRes_rsq__70->SetEntries(49);
   ...
   vH_LowRes_rsq__71->SetBinContent(1,0.0007735559);
   vH_LowRes_rsq__71->SetBinContent(2,0.007477708);
   vH_LowRes_rsq__71->SetBinContent(3,0.001804964);
   vH_LowRes_rsq__71->SetBinContent(4,0.000257852);
   vH_LowRes_rsq__71->SetBinContent(5,0.000257852);
   vH_LowRes_rsq__71->SetBinError(1,0.0004466127);
   vH_LowRes_rsq__71->SetBinError(2,0.001388575);
   vH_LowRes_rsq__71->SetBinError(3,0.0006822122);
   ...
   ttH_LowRes_rsq__72->SetBinContent(1,0.004845052);
   ttH_LowRes_rsq__72->SetBinContent(2,0.01938022);
   ttH_LowRes_rsq__72->SetBinContent(3,0.00809409);
   ttH_LowRes_rsq__72->SetBinContent(4,0.004446048);
   ttH_LowRes_rsq__72->SetBinContent(5,0.001653016);
   ttH_LowRes_rsq__72->SetBinContent(6,0.00102601);
   ttH_LowRes_rsq__72->SetBinContent(7,0.0006270061);
   ttH_LowRes_rsq__72->SetBinContent(8,0.0003420033);
   ttH_LowRes_rsq__72->SetBinContent(9,0.0003420033);
   ttH_LowRes_rsq__72->SetBinContent(10,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinContent(11,0.0002850028);
   ttH_LowRes_rsq__72->SetBinContent(12,0.0001710017);
   ttH_LowRes_rsq__72->SetBinContent(13,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinContent(15,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinContent(19,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinError(1,0.0005255192);
   ttH_LowRes_rsq__72->SetBinError(2,0.001051038);
   ttH_LowRes_rsq__72->SetBinError(3,0.00067924);
   ttH_LowRes_rsq__72->SetBinError(4,0.0005034153);
   ttH_LowRes_rsq__72->SetBinError(5,0.0003069574);
   ttH_LowRes_rsq__72->SetBinError(6,0.0002418329);
   ttH_LowRes_rsq__72->SetBinError(7,0.0001890495);
   ttH_LowRes_rsq__72->SetBinError(8,0.0001396223);
   ttH_LowRes_rsq__72->SetBinError(9,0.0001396223);
   ttH_LowRes_rsq__72->SetBinError(10,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinError(11,0.0001274571);
   ttH_LowRes_rsq__72->SetBinError(12,9.872786e-05);
   ttH_LowRes_rsq__72->SetBinError(13,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinError(15,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinError(19,5.700056e-05);
   ttH_LowRes_rsq__72->SetEntries(727);
