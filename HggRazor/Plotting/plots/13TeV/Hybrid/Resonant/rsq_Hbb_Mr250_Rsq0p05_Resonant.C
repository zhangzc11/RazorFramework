void rsq_Hbb_Mr250_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:22 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.044824,1.060241,-0.8669196);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.1291469);
   
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",125,0,5);
   hs_stack_6->SetMinimum(0.09473805);
   hs_stack_6->SetMaximum(0.1320162);
   ...
   ttH_Hbb_rsq__24->SetBinContent(2,0.01214114);
   ...
   ttH_Hbb_rsq__24->SetBinError(2,0.0008318958);
   ...
   ttH_Hbb_rsq__24->SetEntries(587);
