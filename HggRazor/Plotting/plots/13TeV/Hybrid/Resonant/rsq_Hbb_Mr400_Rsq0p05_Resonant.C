void rsq_Hbb_Mr400_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-4.76556,1.060241,-1.061857);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.05073055);
   
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",125,0,5);
   hs_stack_6->SetMinimum(0.1172835);
   hs_stack_6->SetMaximum(0.04774018);
   ...
   ttH_Hbb_rsq__24->SetBinContent(2,0.005073055);
   ttH_Hbb_rsq__24->SetBinContent(3,0.002850029);
   ttH_Hbb_rsq__24->SetBinContent(4,0.0009120089);
   ttH_Hbb_rsq__24->SetBinContent(5,0.0009690094);
   ttH_Hbb_rsq__24->SetBinContent(6,0.0004560044);
   ttH_Hbb_rsq__24->SetBinContent(7,0.0003420033);
   ttH_Hbb_rsq__24->SetBinContent(8,0.0001140011);
   ttH_Hbb_rsq__24->SetBinContent(9,0.0001710017);
   ttH_Hbb_rsq__24->SetBinContent(11,5.700056e-05);
   ...
   ttH_Hbb_rsq__24->SetBinError(2,0.0005377422);
   ttH_Hbb_rsq__24->SetBinError(3,0.0004030548);
   ttH_Hbb_rsq__24->SetBinError(4,0.0002280022);
   ttH_Hbb_rsq__24->SetBinError(5,0.0002350193);
   ttH_Hbb_rsq__24->SetBinError(6,0.0001612219);
   ttH_Hbb_rsq__24->SetBinError(7,0.0001396223);
   ttH_Hbb_rsq__24->SetBinError(8,8.061096e-05);
   ttH_Hbb_rsq__24->SetBinError(9,9.872786e-05);
   ttH_Hbb_rsq__24->SetBinError(11,5.700056e-05);
   ...
   ttH_Hbb_rsq__24->SetEntries(195);
