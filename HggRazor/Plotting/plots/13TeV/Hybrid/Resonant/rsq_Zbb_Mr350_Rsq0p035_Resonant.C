void rsq_Zbb_Mr350_Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:10:48 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-4.457214,1.060241,-0.7535106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.09733113);
   
   TH1F *hs_stack_10 = new TH1F("hs_stack_10","",125,0,5);
   hs_stack_10->SetMinimum(0.1005909);
   hs_stack_10->SetMaximum(0.09710243);
   ...
   ttH_Zbb_rsq__40->SetBinContent(1,0.001881018);
   ttH_Zbb_rsq__40->SetBinContent(2,0.009291104);
   ttH_Zbb_rsq__40->SetBinContent(3,0.002736028);
   ttH_Zbb_rsq__40->SetBinContent(4,0.001938019);
   ttH_Zbb_rsq__40->SetBinContent(5,0.0008550083);
   ttH_Zbb_rsq__40->SetBinContent(6,0.0003420033);
   ttH_Zbb_rsq__40->SetBinContent(7,0.0001140011);
   ttH_Zbb_rsq__40->SetBinContent(8,0.0001710017);
   ttH_Zbb_rsq__40->SetBinContent(17,5.700056e-05);
   ttH_Zbb_rsq__40->SetBinError(1,0.0003274433);
   ttH_Zbb_rsq__40->SetBinError(2,0.0007277344);
   ttH_Zbb_rsq__40->SetBinError(3,0.0003949114);
   ttH_Zbb_rsq__40->SetBinError(4,0.0003323675);
   ttH_Zbb_rsq__40->SetBinError(5,0.0002207622);
   ttH_Zbb_rsq__40->SetBinError(6,0.0001396223);
   ttH_Zbb_rsq__40->SetBinError(7,8.061096e-05);
   ttH_Zbb_rsq__40->SetBinError(8,9.872786e-05);
   ttH_Zbb_rsq__40->SetBinError(17,5.700056e-05);
   ttH_Zbb_rsq__40->SetEntries(305);
