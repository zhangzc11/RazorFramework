void rsq_Hbb_Mr250_Rsq0p02_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:10:03 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.12307,1.060241,-0.6249175);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.2059579);
   
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",125,0,5);
   hs_stack_6->SetMinimum(0.0864387);
   hs_stack_6->SetMaximum(0.2188829);
   ...
   vH_Hbb_rsq__23->SetBinContent(1,0.0007735559);
   vH_Hbb_rsq__23->SetBinContent(2,0.0007735559);
   vH_Hbb_rsq__23->SetBinContent(3,0.000257852);
   vH_Hbb_rsq__23->SetBinError(1,0.0004466127);
   vH_Hbb_rsq__23->SetBinError(2,0.0004466127);
   ...
   ttH_Hbb_rsq__24->SetBinContent(1,0.01938022);
   ttH_Hbb_rsq__24->SetBinContent(2,0.01966522);
   ttH_Hbb_rsq__24->SetBinContent(3,0.009405105);
   ttH_Hbb_rsq__24->SetBinContent(4,0.004104044);
   ttH_Hbb_rsq__24->SetBinContent(5,0.00290703);
   ttH_Hbb_rsq__24->SetBinContent(6,0.001539015);
   ttH_Hbb_rsq__24->SetBinContent(7,0.001083011);
   ttH_Hbb_rsq__24->SetBinContent(8,0.0005700056);
   ttH_Hbb_rsq__24->SetBinContent(9,0.0006840067);
   ttH_Hbb_rsq__24->SetBinContent(10,0.0001140011);
   ttH_Hbb_rsq__24->SetBinContent(11,0.0002850028);
   ...
   ttH_Hbb_rsq__24->SetBinContent(15,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(18,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(1,0.001051038);
   ttH_Hbb_rsq__24->SetBinError(2,0.001058738);
   ttH_Hbb_rsq__24->SetBinError(3,0.0007321854);
   ttH_Hbb_rsq__24->SetBinError(4,0.0004836658);
   ttH_Hbb_rsq__24->SetBinError(5,0.0004070654);
   ttH_Hbb_rsq__24->SetBinError(6,0.0002961836);
   ttH_Hbb_rsq__24->SetBinError(7,0.0002484597);
   ttH_Hbb_rsq__24->SetBinError(8,0.0001802516);
   ttH_Hbb_rsq__24->SetBinError(9,0.0001974557);
   ttH_Hbb_rsq__24->SetBinError(10,8.061096e-05);
   ttH_Hbb_rsq__24->SetBinError(11,0.0001274571);
   ...
   ttH_Hbb_rsq__24->SetBinError(15,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(18,5.700056e-05);
   ttH_Hbb_rsq__24->SetEntries(1059);
