void mr_HighRes_Mr400_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-1.182018,2147.47,-0.4346024);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.2976889);
   
   TH1F *hs_stack_13 = new TH1F("hs_stack_13","",160,130,8130);
   hs_stack_13->SetMinimum(0.0808485);
   hs_stack_13->SetMaximum(0.3258956);
   ...
   ggH_HighRes_mr__49->SetBinContent(6,0.02002852);
   ...
   ggH_HighRes_mr__49->SetBinError(6,0.01001426);
   ...
   vbfH_HighRes_mr__50->SetBinContent(6,0.001326026);
   ...
   vbfH_HighRes_mr__50->SetBinError(6,0.0007655813);
   ...
   vbfH_HighRes_mr__50->SetEntries(9);
   ...
   vH_HighRes_mr__51->SetBinContent(6,0.00128926);
   ...
   vH_HighRes_mr__51->SetBinError(6,0.0005765745);
   ...
   vH_HighRes_mr__51->SetEntries(21);
   ...
   ttH_HighRes_mr__52->SetBinContent(6,0.007125079);
   ...
   ttH_HighRes_mr__52->SetBinError(6,0.0006372856);
   ...
   ttH_HighRes_mr__52->SetEntries(673);
