...
//=========  (Wed Jun 10 21:06:38 2015) by ROOT version6.03/05
   ...
   c->Range(-0.1445783,-1.313331,1.060241,0.01330613);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.711377);
   
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",125,0,5);
   hs_stack_6->SetMinimum(0.07012377);
   hs_stack_6->SetMaximum(0.8326098);
   ...
   ggH_Hbb_rsq__21->SetBinContent(1,0.01502139);
   ggH_Hbb_rsq__21->SetBinError(1,0.008672604);
   ...
   vbfH_Hbb_rsq__22->SetBinContent(1,0.002210043);
   vbfH_Hbb_rsq__22->SetBinContent(2,0.0004420086);
   vbfH_Hbb_rsq__22->SetBinContent(3,0.0004420086);
   vbfH_Hbb_rsq__22->SetBinContent(7,0.0004420086);
   vbfH_Hbb_rsq__22->SetBinError(1,0.0009883612);
   vbfH_Hbb_rsq__22->SetBinError(2,0.0004420086);
   vbfH_Hbb_rsq__22->SetBinError(3,0.0004420086);
   vbfH_Hbb_rsq__22->SetBinError(7,0.0004420086);
   vbfH_Hbb_rsq__22->SetEntries(8);
   ...
   vH_Hbb_rsq__23->SetBinContent(1,0.002320668);
   vH_Hbb_rsq__23->SetBinContent(2,0.003094224);
   vH_Hbb_rsq__23->SetBinContent(3,0.0007735559);
   vH_Hbb_rsq__23->SetBinError(1,0.0007735559);
   vH_Hbb_rsq__23->SetBinError(2,0.0008932254);
   vH_Hbb_rsq__23->SetBinError(3,0.0004466127);
   vH_Hbb_rsq__23->SetEntries(24);
   ...
   ttH_Hbb_rsq__24->SetBinContent(1,0.0515856);
   ttH_Hbb_rsq__24->SetBinContent(2,0.02251526);
   ttH_Hbb_rsq__24->SetBinContent(3,0.01242614);
   ttH_Hbb_rsq__24->SetBinContent(4,0.00547206);
   ttH_Hbb_rsq__24->SetBinContent(5,0.004275046);
   ttH_Hbb_rsq__24->SetBinContent(6,0.002394024);
   ttH_Hbb_rsq__24->SetBinContent(7,0.001368013);
   ttH_Hbb_rsq__24->SetBinContent(8,0.0009690094);
   ttH_Hbb_rsq__24->SetBinContent(9,0.001311013);
   ttH_Hbb_rsq__24->SetBinContent(10,0.0001140011);
   ttH_Hbb_rsq__24->SetBinContent(11,0.0004560044);
   ttH_Hbb_rsq__24->SetBinContent(12,0.0005700056);
   ttH_Hbb_rsq__24->SetBinContent(13,0.0002280022);
   ttH_Hbb_rsq__24->SetBinContent(14,0.0002850028);
   ttH_Hbb_rsq__24->SetBinContent(15,0.0002850028);
   ttH_Hbb_rsq__24->SetBinContent(17,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(18,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(19,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(22,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(1,0.00171476);
   ttH_Hbb_rsq__24->SetBinError(2,0.001132864);
   ttH_Hbb_rsq__24->SetBinError(3,0.0008416031);
   ttH_Hbb_rsq__24->SetBinError(4,0.0005584891);
   ttH_Hbb_rsq__24->SetBinError(5,0.0004936393);
   ttH_Hbb_rsq__24->SetBinError(6,0.0003694058);
   ttH_Hbb_rsq__24->SetBinError(7,0.0002792446);
   ttH_Hbb_rsq__24->SetBinError(8,0.0002350193);
   ttH_Hbb_rsq__24->SetBinError(9,0.0002733651);
   ttH_Hbb_rsq__24->SetBinError(10,8.061096e-05);
   ttH_Hbb_rsq__24->SetBinError(11,0.0001612219);
   ttH_Hbb_rsq__24->SetBinError(12,0.0001802516);
   ttH_Hbb_rsq__24->SetBinError(13,0.0001140011);
   ttH_Hbb_rsq__24->SetBinError(14,0.0001274571);
   ttH_Hbb_rsq__24->SetBinError(15,0.0001274571);
   ttH_Hbb_rsq__24->SetBinError(17,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(18,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(19,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(22,5.700056e-05);
   ttH_Hbb_rsq__24->SetEntries(1833);
