void ptgg_Zbb_Mr250_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:22 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-4.900409,762.1687,-1.196706);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.03819041);
   
   TH1F *hs_stack_12 = new TH1F("hs_stack_12","",70,20,720);
   hs_stack_12->SetMinimum(0.1264259);
   hs_stack_12->SetMaximum(0.03499734);
   ...
   ttH_Zbb_ptgg__48->SetBinContent(1,0.0009690094);
   ttH_Zbb_ptgg__48->SetBinContent(2,0.001596016);
   ttH_Zbb_ptgg__48->SetBinContent(3,0.002451025);
   ttH_Zbb_ptgg__48->SetBinContent(4,0.003420036);
   ttH_Zbb_ptgg__48->SetBinContent(5,0.003021031);
   ttH_Zbb_ptgg__48->SetBinContent(6,0.003078032);
   ttH_Zbb_ptgg__48->SetBinContent(7,0.003135033);
   ttH_Zbb_ptgg__48->SetBinContent(8,0.003819041);
   ttH_Zbb_ptgg__48->SetBinContent(9,0.002964031);
   ttH_Zbb_ptgg__48->SetBinError(1,0.0002350193);
   ttH_Zbb_ptgg__48->SetBinError(2,0.0003016186);
   ttH_Zbb_ptgg__48->SetBinError(3,0.0003737777);
   ttH_Zbb_ptgg__48->SetBinError(4,0.0004415244);
   ttH_Zbb_ptgg__48->SetBinError(5,0.0004149703);
   ttH_Zbb_ptgg__48->SetBinError(6,0.0004188668);
   ttH_Zbb_ptgg__48->SetBinError(7,0.0004227274);
   ttH_Zbb_ptgg__48->SetBinError(8,0.0004665697);
   ttH_Zbb_ptgg__48->SetBinError(9,0.0004110369);
   ttH_Zbb_ptgg__48->SetEntries(429);
