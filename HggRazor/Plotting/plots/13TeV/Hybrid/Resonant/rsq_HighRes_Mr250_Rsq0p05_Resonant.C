void rsq_HighRes_Mr250_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:22 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.631057,1.060241,1.224306);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(7.681879);
   
   TH1F *hs_stack_14 = new TH1F("hs_stack_14","",125,0,5);
   hs_stack_14->SetMinimum(0.05147386);
   hs_stack_14->SetMaximum(10.57867);
   ...
   ggH_HighRes_rsq__53->SetBinContent(2,0.6208841);
   ...
   ggH_HighRes_rsq__53->SetBinError(2,0.05575704);
   ...
   ggH_HighRes_rsq__53->SetEntries(160);
   ...
   vbfH_HighRes_rsq__54->SetBinContent(2,0.08309756);
   ...
   vbfH_HighRes_rsq__54->SetBinError(2,0.006060516);
   ...
   vbfH_HighRes_rsq__54->SetEntries(260);
   ...
   vH_HighRes_rsq__55->SetBinContent(2,0.02630087);
   ...
   vH_HighRes_rsq__55->SetBinError(2,0.002604177);
   ...
   vH_HighRes_rsq__55->SetEntries(208);
   ...
   ttH_HighRes_rsq__56->SetBinContent(2,0.03790544);
   ...
   ttH_HighRes_rsq__56->SetBinError(2,0.001469907);
   ...
   ttH_HighRes_rsq__56->SetEntries(1686);
