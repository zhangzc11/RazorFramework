void rsq_Hbb_Mr350_Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:10:48 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.040526,1.060241,-0.8798579);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.1259714);
   
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",125,0,5);
   hs_stack_6->SetMinimum(0.09522576);
   hs_stack_6->SetMaximum(0.1284977);
   ...
   ttH_Hbb_rsq__24->SetBinContent(1,0.002508025);
   ttH_Hbb_rsq__24->SetBinContent(2,0.01259714);
   ttH_Hbb_rsq__24->SetBinContent(3,0.004389047);
   ttH_Hbb_rsq__24->SetBinContent(4,0.001881018);
   ttH_Hbb_rsq__24->SetBinContent(5,0.001368013);
   ttH_Hbb_rsq__24->SetBinContent(6,0.0006840067);
   ttH_Hbb_rsq__24->SetBinContent(7,0.0005700056);
   ttH_Hbb_rsq__24->SetBinContent(8,0.0002280022);
   ttH_Hbb_rsq__24->SetBinContent(9,0.0001710017);
   ttH_Hbb_rsq__24->SetBinContent(10,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(11,0.0001710017);
   ttH_Hbb_rsq__24->SetBinContent(12,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(13,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinContent(14,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(1,0.0003780989);
   ttH_Hbb_rsq__24->SetBinError(2,0.0008473742);
   ttH_Hbb_rsq__24->SetBinError(3,0.0005001779);
   ttH_Hbb_rsq__24->SetBinError(4,0.0003274433);
   ttH_Hbb_rsq__24->SetBinError(5,0.0002792446);
   ttH_Hbb_rsq__24->SetBinError(6,0.0001974557);
   ttH_Hbb_rsq__24->SetBinError(7,0.0001802516);
   ttH_Hbb_rsq__24->SetBinError(8,0.0001140011);
   ttH_Hbb_rsq__24->SetBinError(9,9.872786e-05);
   ttH_Hbb_rsq__24->SetBinError(10,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(11,9.872786e-05);
   ttH_Hbb_rsq__24->SetBinError(12,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(13,5.700056e-05);
   ttH_Hbb_rsq__24->SetBinError(14,5.700056e-05);
   ttH_Hbb_rsq__24->SetEntries(435);
