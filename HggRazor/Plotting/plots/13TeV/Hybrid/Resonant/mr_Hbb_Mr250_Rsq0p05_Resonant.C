void mr_Hbb_Mr250_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:22 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-4.587815,2147.47,-0.8841109);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.07382931);
   
   TH1F *hs_stack_5 = new TH1F("hs_stack_5","",160,130,8130);
   hs_stack_5->SetMinimum(0.1070533);
   hs_stack_5->SetMaximum(0.0718836);
   ...
   ttH_Hbb_mr__20->SetBinContent(3,0.005985066);
   ttH_Hbb_mr__20->SetBinContent(4,0.007068078);
   ttH_Hbb_mr__20->SetBinContent(5,0.007125079);
   ttH_Hbb_mr__20->SetBinContent(6,0.004389047);
   ttH_Hbb_mr__20->SetBinContent(7,0.003135033);
   ttH_Hbb_mr__20->SetBinContent(8,0.001938019);
   ttH_Hbb_mr__20->SetBinContent(9,0.001425014);
   ttH_Hbb_mr__20->SetBinContent(10,0.000513005);
   ttH_Hbb_mr__20->SetBinContent(11,0.000513005);
   ttH_Hbb_mr__20->SetBinContent(12,0.000513005);
   ttH_Hbb_mr__20->SetBinContent(13,0.0002850028);
   ttH_Hbb_mr__20->SetBinContent(14,0.0002280022);
   ttH_Hbb_mr__20->SetBinContent(15,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(16,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(19,5.700056e-05);
   ...
   ttH_Hbb_mr__20->SetBinError(3,0.0005840819);
   ttH_Hbb_mr__20->SetBinError(4,0.0006347313);
   ttH_Hbb_mr__20->SetBinError(5,0.0006372856);
   ttH_Hbb_mr__20->SetBinError(6,0.0005001779);
   ttH_Hbb_mr__20->SetBinError(7,0.0004227274);
   ttH_Hbb_mr__20->SetBinError(8,0.0003323675);
   ttH_Hbb_mr__20->SetBinError(9,0.0002850028);
   ttH_Hbb_mr__20->SetBinError(10,0.0001710017);
   ttH_Hbb_mr__20->SetBinError(11,0.0001710017);
   ttH_Hbb_mr__20->SetBinError(12,0.0001710017);
   ttH_Hbb_mr__20->SetBinError(13,0.0001274571);
   ttH_Hbb_mr__20->SetBinError(14,0.0001140011);
   ttH_Hbb_mr__20->SetBinError(15,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(16,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(19,5.700056e-05);
