void mr_Zbb_Mr400_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-5.283766,2147.47,-1.580062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.01710017);
   
   TH1F *hs_stack_9 = new TH1F("hs_stack_9","",160,130,8130);
   hs_stack_9->SetMinimum(0.162206);
   hs_stack_9->SetMaximum(0.014477);
   ...
   ttH_Zbb_mr__36->SetBinContent(6,0.001653016);
   ...
   ttH_Zbb_mr__36->SetBinError(6,0.0003069574);
