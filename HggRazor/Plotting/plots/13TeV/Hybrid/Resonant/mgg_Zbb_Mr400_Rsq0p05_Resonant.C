void mgg_Zbb_Mr400_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(94.75904,-0.0009753435,163.4337,0.007152519);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   ttH_Zbb_mgg__44->SetBinContent(11,0.0001140011);
   ttH_Zbb_mgg__44->SetBinContent(12,0.0001140011);
   ttH_Zbb_mgg__44->SetBinContent(13,0.0006270061);
   ttH_Zbb_mgg__44->SetBinContent(14,0.002166021);
   ttH_Zbb_mgg__44->SetBinContent(15,0.003135033);
   ...
   ttH_Zbb_mgg__44->SetBinContent(25,5.700056e-05);
   ttH_Zbb_mgg__44->SetBinContent(31,5.700056e-05);
   ...
   ttH_Zbb_mgg__44->SetBinError(11,8.061096e-05);
   ttH_Zbb_mgg__44->SetBinError(12,8.061096e-05);
   ttH_Zbb_mgg__44->SetBinError(13,0.0001890495);
   ttH_Zbb_mgg__44->SetBinError(14,0.000351375);
   ttH_Zbb_mgg__44->SetBinError(15,0.0004227274);
   ...
   ttH_Zbb_mgg__44->SetBinError(25,5.700056e-05);
   ttH_Zbb_mgg__44->SetBinError(31,5.700056e-05);
   ttH_Zbb_mgg__44->SetBinError(33,5.700056e-05);
   ttH_Zbb_mgg__44->SetEntries(140);
