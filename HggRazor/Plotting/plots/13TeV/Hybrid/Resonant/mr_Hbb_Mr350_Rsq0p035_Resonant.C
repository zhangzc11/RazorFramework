void mr_Hbb_Mr350_Rsq0p035_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:10:48 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-201.9277,-4.71988,2147.47,-1.016176);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.05586061);
   
   TH1F *hs_stack_5 = new TH1F("hs_stack_5","",160,130,8130);
   hs_stack_5->SetMinimum(0.114475);
   hs_stack_5->SetMaximum(0.05303525);
   ...
   ttH_Hbb_mr__20->SetBinContent(5,0.004845052);
   ttH_Hbb_mr__20->SetBinContent(6,0.005586061);
   ttH_Hbb_mr__20->SetBinContent(7,0.004389047);
   ttH_Hbb_mr__20->SetBinContent(8,0.002793029);
   ttH_Hbb_mr__20->SetBinContent(9,0.002451025);
   ttH_Hbb_mr__20->SetBinContent(10,0.001254012);
   ttH_Hbb_mr__20->SetBinContent(11,0.0008550083);
   ttH_Hbb_mr__20->SetBinContent(12,0.0007980078);
   ttH_Hbb_mr__20->SetBinContent(13,0.0005700056);
   ttH_Hbb_mr__20->SetBinContent(14,0.0004560044);
   ttH_Hbb_mr__20->SetBinContent(15,0.0001710017);
   ttH_Hbb_mr__20->SetBinContent(16,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(18,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(19,0.0001140011);
   ttH_Hbb_mr__20->SetBinContent(20,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(21,0.0001710017);
   ttH_Hbb_mr__20->SetBinContent(23,5.700056e-05);
   ttH_Hbb_mr__20->SetBinContent(26,0.0001140011);
   ttH_Hbb_mr__20->SetBinError(5,0.0005255192);
   ttH_Hbb_mr__20->SetBinError(6,0.0005642767);
   ttH_Hbb_mr__20->SetBinError(7,0.0005001779);
   ttH_Hbb_mr__20->SetBinError(8,0.0003990039);
   ttH_Hbb_mr__20->SetBinError(9,0.0003737777);
   ttH_Hbb_mr__20->SetBinError(10,0.0002673563);
   ttH_Hbb_mr__20->SetBinError(11,0.0002207622);
   ttH_Hbb_mr__20->SetBinError(12,0.0002132766);
   ttH_Hbb_mr__20->SetBinError(13,0.0001802516);
   ttH_Hbb_mr__20->SetBinError(14,0.0001612219);
   ttH_Hbb_mr__20->SetBinError(15,9.872786e-05);
   ttH_Hbb_mr__20->SetBinError(16,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(18,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(19,8.061096e-05);
   ttH_Hbb_mr__20->SetBinError(20,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(21,9.872786e-05);
   ttH_Hbb_mr__20->SetBinError(23,5.700056e-05);
   ttH_Hbb_mr__20->SetBinError(26,8.061096e-05);
   ttH_Hbb_mr__20->SetEntries(435);
