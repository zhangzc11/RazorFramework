void ptgg_LowRes_Mr250_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:22 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-81.20482,-1.383239,762.1687,0.2647912);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(1.162868);
   
   TH1F *hs_stack_20 = new TH1F("hs_stack_20","",70,20,720);
   hs_stack_20->SetMinimum(0.06524157);
   hs_stack_20->SetMaximum(1.410682);
   ...
   ggH_LowRes_ptgg__77->SetBinContent(1,0.03004278);
   ggH_LowRes_ptgg__77->SetBinContent(2,0.02503565);
   ggH_LowRes_ptgg__77->SetBinContent(3,0.02002852);
   ggH_LowRes_ptgg__77->SetBinContent(4,0.03504991);
   ggH_LowRes_ptgg__77->SetBinContent(5,0.06008555);
   ggH_LowRes_ptgg__77->SetBinContent(6,0.04506417);
   ggH_LowRes_ptgg__77->SetBinContent(7,0.09513548);
   ggH_LowRes_ptgg__77->SetBinContent(8,0.06509268);
   ggH_LowRes_ptgg__77->SetBinContent(9,0.07510695);
   ggH_LowRes_ptgg__77->SetBinError(1,0.01226491);
   ggH_LowRes_ptgg__77->SetBinError(2,0.01119628);
   ggH_LowRes_ptgg__77->SetBinError(3,0.01001426);
   ggH_LowRes_ptgg__77->SetBinError(4,0.01324762);
   ggH_LowRes_ptgg__77->SetBinError(5,0.01734521);
   ggH_LowRes_ptgg__77->SetBinError(6,0.01502139);
   ggH_LowRes_ptgg__77->SetBinError(7,0.02182557);
   ggH_LowRes_ptgg__77->SetBinError(8,0.01805346);
   ggH_LowRes_ptgg__77->SetBinError(9,0.01939253);
   ggH_LowRes_ptgg__77->SetEntries(90);
   ...
   vbfH_LowRes_ptgg__78->SetBinContent(1,0.001326026);
   vbfH_LowRes_ptgg__78->SetBinContent(2,0.00309406);
   vbfH_LowRes_ptgg__78->SetBinContent(3,0.001768034);
   vbfH_LowRes_ptgg__78->SetBinContent(4,0.004420085);
   vbfH_LowRes_ptgg__78->SetBinContent(5,0.004862094);
   vbfH_LowRes_ptgg__78->SetBinContent(6,0.005304102);
   vbfH_LowRes_ptgg__78->SetBinContent(7,0.009724188);
   vbfH_LowRes_ptgg__78->SetBinContent(8,0.01237624);
   vbfH_LowRes_ptgg__78->SetBinContent(9,0.01326026);
   vbfH_LowRes_ptgg__78->SetBinError(1,0.0007655813);
   vbfH_LowRes_ptgg__78->SetBinError(2,0.001169445);
   vbfH_LowRes_ptgg__78->SetBinError(3,0.0008840172);
   vbfH_LowRes_ptgg__78->SetBinError(4,0.001397754);
   vbfH_LowRes_ptgg__78->SetBinError(5,0.001465977);
   vbfH_LowRes_ptgg__78->SetBinError(6,0.001531163);
   vbfH_LowRes_ptgg__78->SetBinError(7,0.002073204);
   vbfH_LowRes_ptgg__78->SetBinError(8,0.00233889);
   vbfH_LowRes_ptgg__78->SetBinError(9,0.002420981);
   vbfH_LowRes_ptgg__78->SetEntries(127);
   ...
   vH_LowRes_ptgg__79->SetBinContent(1,0.001804964);
   vH_LowRes_ptgg__79->SetBinContent(2,0.00128926);
   vH_LowRes_ptgg__79->SetBinContent(3,0.001804964);
   vH_LowRes_ptgg__79->SetBinContent(4,0.00257852);
   vH_LowRes_ptgg__79->SetBinContent(5,0.00128926);
   vH_LowRes_ptgg__79->SetBinContent(6,0.003094224);
   vH_LowRes_ptgg__79->SetBinContent(7,0.00515704);
   vH_LowRes_ptgg__79->SetBinContent(8,0.005672744);
   vH_LowRes_ptgg__79->SetBinContent(9,0.009024818);
   vH_LowRes_ptgg__79->SetBinError(1,0.0006822122);
   vH_LowRes_ptgg__79->SetBinError(2,0.0005765745);
   vH_LowRes_ptgg__79->SetBinError(3,0.0006822122);
   vH_LowRes_ptgg__79->SetBinError(4,0.0008153995);
   vH_LowRes_ptgg__79->SetBinError(5,0.0005765745);
   vH_LowRes_ptgg__79->SetBinError(6,0.0008932254);
   vH_LowRes_ptgg__79->SetBinError(7,0.001153149);
   vH_LowRes_ptgg__79->SetBinError(8,0.001209433);
   vH_LowRes_ptgg__79->SetBinError(9,0.001525473);
   vH_LowRes_ptgg__79->SetEntries(123);
   ...
   ttH_LowRes_ptgg__80->SetBinContent(1,0.002280023);
   ttH_LowRes_ptgg__80->SetBinContent(2,0.004788052);
   ttH_LowRes_ptgg__80->SetBinContent(3,0.005358058);
   ttH_LowRes_ptgg__80->SetBinContent(4,0.00638407);
   ttH_LowRes_ptgg__80->SetBinContent(5,0.007638085);
   ttH_LowRes_ptgg__80->SetBinContent(6,0.006099067);
   ttH_LowRes_ptgg__80->SetBinContent(7,0.006270069);
   ttH_LowRes_ptgg__80->SetBinContent(8,0.007581085);
   ttH_LowRes_ptgg__80->SetBinContent(9,0.007125079);
   ttH_LowRes_ptgg__80->SetBinError(1,0.0003605032);
   ttH_LowRes_ptgg__80->SetBinError(2,0.0005224187);
   ttH_LowRes_ptgg__80->SetBinError(3,0.0005526409);
   ttH_LowRes_ptgg__80->SetBinError(4,0.0006032372);
   ttH_LowRes_ptgg__80->SetBinError(5,0.0006598292);
   ttH_LowRes_ptgg__80->SetBinError(6,0.0005896184);
   ttH_LowRes_ptgg__80->SetBinError(7,0.0005978269);
   ttH_LowRes_ptgg__80->SetBinError(8,0.0006573625);
   ttH_LowRes_ptgg__80->SetBinError(9,0.0006372856);
   ttH_LowRes_ptgg__80->SetEntries(939);
