void rsq_LowRes_Mr250_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:22 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.551816,1.060241,0.9064159);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(4.101254);
   
   TH1F *hs_stack_18 = new TH1F("hs_stack_18","",125,0,5);
   hs_stack_18->SetMinimum(0.05535694);
   hs_stack_18->SetMaximum(5.42425);
   ...
   ggH_LowRes_rsq__69->SetBinContent(2,0.3304705);
   ...
   ggH_LowRes_rsq__69->SetBinError(2,0.04067812);
   ...
   ggH_LowRes_rsq__69->SetEntries(90);
   ...
   vbfH_LowRes_rsq__70->SetBinContent(2,0.04110684);
   ...
   vbfH_LowRes_rsq__70->SetBinError(2,0.004262576);
   ...
   vbfH_LowRes_rsq__70->SetEntries(127);
   ...
   vH_LowRes_rsq__71->SetBinContent(2,0.01933888);
   ...
   vH_LowRes_rsq__71->SetBinError(2,0.002233064);
   ...
   vH_LowRes_rsq__71->SetEntries(123);
   ...
   ttH_LowRes_rsq__72->SetBinContent(2,0.01920922);
   ...
   ttH_LowRes_rsq__72->SetBinError(2,0.001046391);
   ...
   ttH_LowRes_rsq__72->SetEntries(939);
