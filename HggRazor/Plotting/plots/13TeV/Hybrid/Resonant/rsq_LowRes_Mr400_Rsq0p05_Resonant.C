void rsq_LowRes_Mr400_Rsq0p05_Resonant()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jun 10 21:11:47 2015) by ROOT version6.03/05
   TCanvas *c = new TCanvas("c", "c",0,0,800,700);
   c->SetHighLightColor(2);
   c->Range(-0.1445783,-1.188723,1.060241,-0.4125256);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hs->SetTitle("");
   hs->SetMinimum(0.1);
   hs->SetMaximum(0.3107078);
   
   TH1F *hs_stack_18 = new TH1F("hs_stack_18","",125,0,5);
   hs_stack_18->SetMinimum(0.08024548);
   hs_stack_18->SetMaximum(0.3413034);
   ...
   ggH_LowRes_rsq__69->SetBinContent(2,0.01502139);
   ggH_LowRes_rsq__69->SetBinContent(3,0.00500713);
   ggH_LowRes_rsq__69->SetBinError(2,0.008672604);
   ggH_LowRes_rsq__69->SetBinError(3,0.00500713);
   ggH_LowRes_rsq__69->SetEntries(4);
   ...
   vbfH_LowRes_rsq__70->SetBinContent(2,0.00309406);
   vbfH_LowRes_rsq__70->SetBinError(2,0.001169445);
   vbfH_LowRes_rsq__70->SetEntries(7);
   ...
   vH_LowRes_rsq__71->SetBinContent(2,0.003094224);
   vH_LowRes_rsq__71->SetBinContent(3,0.0005157039);
   vH_LowRes_rsq__71->SetBinError(2,0.0008932254);
   vH_LowRes_rsq__71->SetBinError(3,0.0003646577);
   vH_LowRes_rsq__71->SetEntries(14);
   ...
   ttH_LowRes_rsq__72->SetBinContent(2,0.009861111);
   ttH_LowRes_rsq__72->SetBinContent(3,0.005814064);
   ttH_LowRes_rsq__72->SetBinContent(4,0.00290703);
   ttH_LowRes_rsq__72->SetBinContent(5,0.001140011);
   ttH_LowRes_rsq__72->SetBinContent(6,0.0006840067);
   ttH_LowRes_rsq__72->SetBinContent(7,0.0003990039);
   ttH_LowRes_rsq__72->SetBinContent(8,0.0002850028);
   ttH_LowRes_rsq__72->SetBinContent(9,0.0002280022);
   ttH_LowRes_rsq__72->SetBinContent(10,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinContent(11,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinContent(12,0.0001140011);
   ttH_LowRes_rsq__72->SetBinContent(19,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinError(2,0.0007497253);
   ttH_LowRes_rsq__72->SetBinError(3,0.0005756774);
   ttH_LowRes_rsq__72->SetBinError(4,0.0004070654);
   ttH_LowRes_rsq__72->SetBinError(5,0.0002549142);
   ttH_LowRes_rsq__72->SetBinError(6,0.0001974557);
   ttH_LowRes_rsq__72->SetBinError(7,0.0001508093);
   ttH_LowRes_rsq__72->SetBinError(8,0.0001274571);
   ttH_LowRes_rsq__72->SetBinError(9,0.0001140011);
   ttH_LowRes_rsq__72->SetBinError(10,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinError(11,5.700056e-05);
   ttH_LowRes_rsq__72->SetBinError(12,8.061096e-05);
   ttH_LowRes_rsq__72->SetBinError(19,5.700056e-05);
   ttH_LowRes_rsq__72->SetEntries(379);
