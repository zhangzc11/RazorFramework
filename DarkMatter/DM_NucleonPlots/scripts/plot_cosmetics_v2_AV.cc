{
  ...
  TGraph* Lmono = (TGraph*)f3->Get("Monojet_AV_8TeV");
  ...
  */
  ...
  TLegend* leg = new TLegend(0.46, 0.75, 0.87, 0.89);//(xmin, ymin, xmax, ymax)
  leg->AddEntry(Ldown, "Razor AV Expected -1#sigma (18.836 fb^{-1})" ,"l");
  leg->AddEntry(Lcom, "Razor AV Expected (18.836 fb^{-1})" ,"l");
  leg->AddEntry(Lup, "Razor AV Expected +1#sigma (18.836 fb^{-1})" ,"l");
  leg->AddEntry(Lc, "Razor AV Observed (18.836 fb^{-1})" ,"l");
  ...
  //TString splot = "_CorrBkg_Except_ttbar_LN";
  //TString splot = "_CorrBkg_Except_ttbar_LN_CorrNorm";
  //TString splot = "_CorrBkg_Except_ttbar_LN_CorrNorm_BkgAndSignal";
  //TString splot = "_CorrBkg_Except_ttbar_LN_CorrNorm_OnlySignal";
  ...
  //TString splot = "_CorrBkg_Except_TTbar_NOSIGNALSYS";
  ...
  //TString splot = "_CorrBkg_BinUnCorr";
  ...
  C->SaveAs("AV_LambdaLimit"+splot+".pdf");
  C->SaveAs("AV_LambdaLimit"+splot+".png");
  C->SaveAs("AV_LambdaLimit"+splot+".C");
